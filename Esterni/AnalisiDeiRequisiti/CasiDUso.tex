...
\end{figure}
\subsection{UC5.1.1 - Visualizzazione singolo utente approvato}
\begin{itemize}
\item \textbf{Attori primari:} amministratore;
\item \textbf{Scopo e descrizione:} l'amministratore visualizza le informazioni basilari di un utente registrato nel sistema;
\item \textbf{Scenario principale:} l'amministratore richiede al sistema le informazioni basilari di un utente per poterle visualizzare ed eventualmente compiere altre operazioni su di esso;	\item \textbf{Precondizione:} il sistema riconosce l'utente nel ruolo di amministratore e riceve la richiesta di visualizzazione di un utente aprovato;
\item \textbf{Postcondizione:} il sistema offre all'amministratore le informazioni basilari dell'utente indicato.
\end{itemize}
\begin{figure}[H]
\centering
\includegraphics[width=0.9\linewidth]{UC5_1_1.jpg}
\caption{UC5.1.1 - Visualizzazione singolo utente approvato}
\label{fig:UC5.1.1 - Visualizzazione singolo utente approvato}
\end{figure}
\subsection{UC5.1.1.1 - Visualizzazione indirizzo dell'utente approvato}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	\item \textbf{Scopo e descrizione:} l'amministratore visualizza l'\citGloss{indirizzo} della rete \citGloss{Ethereum} riguardante l'utente indicatogli;
	\item \textbf{Scenario principale:} l'amministratore richiede al sistema le informazioni di un determinato utente per poterne visualizzarne l'\citGloss{indirizzo} ed eventualmente compiere altre operazioni su di esso;
	\item \textbf{Precondizione:} il sistema riconosce l'utente nel ruolo di amministratore e riceve la richiesta di visualizzazione di un utente approvato;
	\item \textbf{Postcondizione:} il sistema offre all'amministratore l'indirizzo relativo all'utente approvato indicato.
\end{itemize}
\subsection{UC5.1.1.2 - Visualizzazione nome dell'utente approvato}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	\item \textbf{Scopo e descrizione:} l'amministratore visualizza il nome riguardante l'utente indicatogli;
	\item \textbf{Scenario principale:} l'amministratore richiede al sistema le informazioni di un determinato utente per poterne visualizzarne il nome ed eventualmente compiere altre operazioni su di esso;
	\item \textbf{Precondizione:} il sistema riconosce l'utente nel ruolo di amministratore e riceve la richiesta di visualizzazione di un utente approvato;
	\item \textbf{Postcondizione:} il sistema offre all'amministratore il nome relativo all'utente approvato indicato.
\end{itemize}
\subsection{UC5.1.1.3 - Visualizzazione cognome dell'utente approvato}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	\item \textbf{Scopo e descrizione:} l'amministratore visualizza il cognome riguardante l'utente indicatogli;
	\item \textbf{Scenario principale:} l'amministratore richiede al sistema le informazioni di un determinato utente per poterne visualizzarne il cognome ed eventualmente compiere altre operazioni su di esso;
	\item \textbf{Precondizione:} il sistema riconosce l'utente nel ruolo di amministratore e riceve la richiesta di visualizzazione di un utente approvato;
	\item \textbf{Postcondizione:} il sistema offre all'amministratore il cognome relativo all'utente approvato indicato.
\end{itemize}
...
\end{figure}
\subsection{UC5.2.1 - Visualizzazione singolo studente approvato}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	\item \textbf{Scopo e descrizione:} l'amministratore visualizza le informazioni basilari di un studente registrato nel sistema;
	\item \textbf{Scenario principale:} l'amministratore richiede al sistema le informazioni basilari di un studente per poterle visualizzare ed eventualmente compiere altre operazioni su di esso;	\item \textbf{Precondizione:} il sistema riconosce l'studente nel ruolo di amministratore e riceve la richiesta di visualizzazione di un studente aprovato;
	\item \textbf{Postcondizione:} il sistema offre all'amministratore le informazioni basilari dell'studente indicato.
\end{itemize}
\begin{figure}[H]
\centering
\includegraphics[width=0.9\linewidth]{UC5_2_1.jpg}
\caption{UC5.2.1 - Visualizzazione singolo studente approvato}
\label{fig:UC5.2.1 - Visualizzazione singolo studente approvato}
\end{figure}
\subsection{UC5.2.1.1 - Visualizzazione nome del corsi di uno studenti approvati}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
...
\caption{UC5.3 - Visualizzazione lista dei professori approvati}
\label{fig:UC5.3 - Visualizzazione lista dei professori approvati}
\end{figure}
\subsection{UC5.3.1 - Visualizzazione singolo professore approvato}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	\item \textbf{Scopo e descrizione:} l'amministratore visualizza le informazioni basilari di un professore registrato nel sistema;
	\item \textbf{Scenario principale:} l'amministratore richiede al sistema le informazioni basilari di un professore per poterle visualizzare ed eventualmente compiere altre operazioni su di esso;	\item \textbf{Precondizione:} il sistema riconosce l'professore nel ruolo di amministratore e riceve la richiesta di visualizzazione di un professore aprovato;
	\item \textbf{Postcondizione:} il sistema offre all'amministratore le informazioni basilari del professore indicato.
\end{itemize}
...
\end{figure}
\subsection{UC5.4.1 - Visualizzazione singolo utente in attesa di abilitazione}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	\item \textbf{Scopo e descrizione:} l'amministratore visualizza le informazioni basilari di un utente in attesa di abilitazione;
	\item \textbf{Scenario principale:} l'amministratore richiede al sistema le informazioni basilari di un utente in attesa di abilitazione per poterle visualizzare ed eventualmente compiere altre operazioni su di esso;
	\item \textbf{Precondizione:} il sistema riconosce l'professore nel ruolo di amministratore e riceve la richiesta di visualizzazione di un utente in attesa di abilitazione;
	\item \textbf{Postcondizione:} il sistema offre all'amministratore le informazioni basilari riguardanti l'utente in attesa di abilitazione.
\end{itemize}
\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{UC5_4_1.jpg}
\caption{UC5.4.1 - Visualizzazione singolo utente in attesa di abilitazione}
\label{fig:UC5.4.1 - Visualizzazione singolo utente in attesa di abilitazione}
\end{figure}
\subsection{UC5.4.1.1 - Visualizzazione indirizzo di un utente in attesa di abilitazione}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
...
\end{itemize}
\subsection{UC5.4.1.2 - Visualizzazione nome di un utente in attesa di abilitazione}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
...
\end{itemize}
\subsection{UC5.4.1.3 - Visualizzazione cognome di un utente in attesa di abilitazione}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
...
\end{itemize}
\subsection{UC5.4.1.4 - Visualizzazione ruolo di un utente in attesa di abilitazione}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
...
\end{itemize}
\subsection{UC5.4.1.5 - Visualizzazione nome del corso di un utente in attesa di abilitazione}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
...
\end{figure}
\subsection{UC6.2.1 - Visualizzazione singolo anno accademico}
\begin{itemize}
\item \textbf{Attori primari:} università;
\item \textbf{Scopo e descrizione:} l'utente è già riconosciuto dal sistema come rappresentante dell'università e visualizza le informazioni basilari di un anno accademico presente nel sistema;
\item \textbf{Scenario principale:} l'utente che rappresenta l'università richiede le informazioni basilari di un anno accademico;
\item \textbf{Precondizione:} il sistema riconosce l'utente nel ruolo di gestore dell'università e riceve una richiesta di visualizzazione di un determinato anno accademico;
\item \textbf{Postcondizione:} il sistema offre all'utente che gestisce l'università informazioni basilari dell'anno accademico richiesto.
\end{itemize}
\begin{figure}[H]
\centering
\includegraphics[width=0.7\linewidth]{UC6_2_1.jpg}
\caption{UC6.2.1 - Visualizzazione singolo anno accademico}
\label{fig:UC6.2.1 - Visualizzazione singolo anno accademico}
\end{figure}
\subsection{UC6.2.1.1 - Visualizzazione anni solari relativo ad un anno accademico}
\begin{itemize}
	\item \textbf{Attori primari:} università;
	\item \textbf{Scopo e descrizione:} l'utente già riconosciuto dal sistema come rappresentante dell'università visualizza un anno accademico, visualizzandolo come numero, relativo all'anno accademico inseriti nella rete \citGloss{Ethereum};
	\item \textbf{Scenario principale:} L'utente che rappresenta l'università richiede al sistema la visualizzazione dell'anno solare relativo a un anno accademico;
	\item \textbf{Precondizione:} il sistema riconosce l'utente nel ruolo di gestore dell'università e riceve una richiesta di visualizzazione dell'anno solare di un determinato anno accademico;
	\item \textbf{Postcondizione:} il sistema offre all'utente che gestisce l'università l'informazione richiesta.
\end{itemize}
...
\end{figure}
\subsection{UC7.2.1 - Visualizzazione corso}
\begin{itemize}
\item \textbf{Attori primari:} amministratore;
\item \textbf{Scopo e descrizione:} viene mostrato un singolo corso, visualizzandone la sigla e l'anno solare dell'anno accademico associato;
\item \textbf{Scenario principale:} l'amministratore visualizza un corso di laurea presente nel sistema;
\item \textbf{Precondizione:} il sistema riconosce l'utente come amministratore e riceve una richiesta di visualizzazione di un corso di laurea;
\item \textbf{Postcondizione:} il sistema fornisce all'utente le informazioni riguardanti il corso richiesto.
\end{itemize}
\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{UC7_2_1.jpg}
\caption{UC7.2.1 - Visualizzazione corso}
\label{fig:UC7.2.1 - Visualizzazione corso}
\end{figure}
\subsection{UC7.2.1.1 - Visualizzazione sigla del corso di laurea}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	\item \textbf{Scopo e descrizione:} l'amministratore visualizza la sigla relativa al corso di laurea;
	\item \textbf{Scenario principale:} l'amministratore richiede la sigla del corso di laurea;
	\item \textbf{Precondizione:} il sistema riconosce l'utente come amministratore e riceve una richiesta di visualizzazione di un corso di laurea; 
	\item \textbf{Postcondizione:} il sistema fornisce all'utente la sigla relativa al corso di laurea.
\end{itemize}
\subsection{UC7.2.1.2 - Visualizzazione anno solare dell'anno accademico associato al corso di laurea}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	\item \textbf{Scopo e descrizione:} l'amministratore visualizza l'anno solare relativo al corso di laurea;
	\item \textbf{Scenario principale:} l'amministratore richiede l'anno solare del corso di laurea;
	\item \textbf{Precondizione:} il sistema riconosce l'utente come amministratore e riceve una richiesta di visualizzazione di un corso di laurea; 
	\item \textbf{Postcondizione:} il sistema fornisce all'utente l'anno solare relativa al corso di laurea.
\end{itemize}
...
\end{figure}
\subsection{UC7.3.1 - Visualizzazione corso di un anno accademico}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	\item \textbf{Scopo e descrizione:} viene mostrato un singolo corso, visualizzandone la sigla e l'anno solare dell'anno accademico associato;
	\item \textbf{Scenario principale:} l'amministratore visualizza un corso di laurea presente nel sistema;
	\item \textbf{Precondizione:} il sistema riconosce l'utente come amministratore e riceve una richiesta di visualizzazione di un corso di laurea di un determinato anno accademico; 
	\item \textbf{Postcondizione:} il sistema fornisce all'utente le informazioni riguardanti il corso richiesto.
\end{itemize}
\begin{figure}[H]
\centering
\includegraphics[width=0.7\linewidth]{UC7_3_1.jpg}
\caption{UC7.3.1 - Visualizzazione corso di un anno accademico}
\label{fig:UC7.3.1 - Visualizzazione corso di un anno accademico}
\end{figure}
\subsection{UC7.3.1.1 - Visualizzazione sigla del corsi di laurea di un determinato anno accademico}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	\item \textbf{Scopo e descrizione:} l'amministratore visualizza la sigla relativa al corso di laurea di un determinato anno accademico;
	\item \textbf{Scenario principale:} l'amministratore richiede la sigla di un determinato anno accademico per poterla visionare;
	\item \textbf{Precondizione:} il sistema riconosce l'utente come amministratore e riceve una richiesta di visualizzazione delle informazioni di un corso di laurea appartenente a un determinato anno accademico; 
	\item \textbf{Postcondizione:} il sistema fornisce all'utente la sigla relativa al corso di laurea dell'anno accademico indicatogli.
\end{itemize}
...
\end{figure}
\subsection{UC7.5.1 - Visualizzazione esame appartenente a un determinato corso}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	\item \textbf{Scopo e descrizione:} vengono visualizzate le informazioni basilari relative ad un esame richiesto; 
	\item \textbf{Precondizione:} il sistema riconosce l'utente come amministratore e riceve una richiesta di visualizzazione delle informazioni di un esame; 
	\item \textbf{Postcondizione:} il sistema fornisce all'amministratore le informazioni basilari dell'esame indicatogli.
\end{itemize}
\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{UC7_5_1.jpg}
\caption{UC7.5.1 - Visualizzazione esame appartenente a un determinato corso}
\label{fig:UC7.5.1 - Visualizzazione esame appartenente a un determinato corso}
\end{figure}
\subsection{UC7.5.1.1 - Visualizzazione sigla esame}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	\item \textbf{Scopo e descrizione:} l'amministratore visualizza la sigla dell'esame indicato;
	\item \textbf{Scenario principale:} il sistema mostra la sigla dell'esame indicato;
	\item \textbf{Precondizione:} il sistema riconosce l'utente come amministratore e riceve una richiesta di visualizzazione di un esame; 
	\item \textbf{Postcondizione:} il sistema fornisce all'amministratore la sigla dell'esame richiesto.
\end{itemize}
\subsection{UC7.5.1.2 - Visualizzazione crediti esame}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	\item \textbf{Scopo e descrizione:} l'amministratore visualizza il numero di crediti dell'esame indicato;
	\item \textbf{Scenario principale:} il sistema mostra il numero di crediti dell'esame indicato;
	\item \textbf{Precondizione:} il sistema riconosce l'utente come amministratore e riceve una richiesta di visualizzazione di un esame; 
	\item \textbf{Postcondizione:} il sistema fornisce all'amministratore il numero di crediti dell'esame richiesto.
\end{itemize}
\subsection{UC7.5.1.3 - Visualizzazione nome del professori associato se presente}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	\item \textbf{Scopo e descrizione:} l'amministratore visualizza il nome del professore assegnato all'esame indicato;
	\item \textbf{Scenario principale:} il sistema mostra il nome del professore assegnato all'esame indicato;
	\item \textbf{Precondizione:} il sistema riconosce l'utente come amministratore e riceve una richiesta di visualizzazione di un esame; 
	\item \textbf{Postcondizione:} il sistema fornisce all'amministratore il nome del professore, ove presente, associato all'esame richiesto.
\end{itemize}
\subsection{UC7.5.1.4 - Visualizzazione cognome del professore associato se presente}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	\item \textbf{Scopo e descrizione:} l'amministratore visualizza il cognome del professore assegnato all'esame indicato;
	\item \textbf{Scenario principale:} il sistema mostra il cognome del professore assegnato all'esame indicato;
	\item \textbf{Precondizione:} il sistema riconosce l'utente come amministratore e riceve una richiesta di visualizzazione di un esame; 
	\item \textbf{Postcondizione:} il sistema fornisce all'amministratore il cognome del professore, ove presente, associato all'esame richiesto.
\end{itemize}
...
\end{figure}
\subsection{UC7.6.1 - Visualizzazione esame}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	\item \textbf{Scopo e descrizione:} vengono visualizzate le informazioni basilari relative ad un esame richiesto; 
	\item \textbf{Precondizione:} il sistema riconosce l'utente come amministratore e riceve una richiesta di visualizzazione delle informazioni di un esame; 
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\linewidth]{UC7_6_1.jpg}
\caption{UC7.6.1 - Visualizzazione esame}
\label{fig:UC7.6.1 - Visualizzazione esame}
\end{figure}
\subsection{UC7.6.1.1 - Visualizzazione sigla esame}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	\item \textbf{Scopo e descrizione:} l'amministratore visualizza la sigla dell'esame indicato;
	\item \textbf{Scenario principale:} il sistema mostra la sigla dell'esame indicato;
	...
	\item \textbf{Postcondizione:} il sistema fornisce all'amministratore la sigla dell'esame richiesto.
\end{itemize}
\subsection{UC7.6.1.2 - Visualizzazione crediti esame}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	\item \textbf{Scopo e descrizione:} l'amministratore visualizza il numero di crediti dell'esame indicato;
	\item \textbf{Scenario principale:} il sistema mostra il numero di crediti dell'esame indicato;
	...
	\item \textbf{Postcondizione:} il sistema fornisce all'amministratore il numero di crediti dell'esame richiesto.
\end{itemize}
\subsection{UC7.6.1.3 - Visualizzazione sigla del corso di laurea associato}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	\item \textbf{Scopo e descrizione:} l'amministratore visualizza la sigla del corso di laurea che contiene l'esame indicato;
	\item \textbf{Scenario principale:} il sistema mostra la sigla del corso di laurea che contiene l'esame indicato;
	\item \textbf{Precondizione:} il sistema riconosce l'utente come amministratore e riceve una richiesta di visualizzazione di un esame; 
	\item \textbf{Postcondizione:} il sistema fornisce all'amministratore la sigla del corso di laurea che contiene l'esame indicato.
\end{itemize}
\subsection{UC7.6.1.4 - Visualizzazione nome del professori associato se presente}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	\item \textbf{Scopo e descrizione:} l'amministratore visualizza il nome del professore assegnato all'esame indicato;
	\item \textbf{Scenario principale:} il sistema mostra il nome del professore assegnato all'esame indicato;
	...
	\item \textbf{Postcondizione:} il sistema fornisce all'amministratore il nome del professore, ove presente, associato all'esame richiesto.
\end{itemize}
\subsection{UC7.6.1.5 - Visualizzazione cognome del professore associato se presente}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	\item \textbf{Scopo e descrizione:} l'amministratore visualizza il cognome del professore assegnato all'esame indicato;
	\item \textbf{Scenario principale:} il sistema mostra il cognome del professore assegnato all'esame indicato;
...
\end{figure}
\subsection{UC7.8.1 - Visualizzazione anno accademico}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	\item \textbf{Scopo e descrizione:} l'utente è già riconosciuto dal sistema come amministratore e visualizza una un anno accademico con le relative informazioni;
	\item \textbf{Scenario principale:} l'amministratore richiede le informazioni basilari relative a un anno accademico;
	\item \textbf{Precondizione:} il sistema riconosce l'utente come amministratore, il quale richiede un anno accademico;
	\item \textbf{Postcondizione:} il sistema visualizza le informazioni relative all'anno accademico indicatogli.
\end{itemize}
\begin{figure}[H]
\centering
\includegraphics[width=0.7\linewidth]{UC7_8_1.jpg}
\caption{UC7.8.1 - Visualizzazione anno accademico}
\label{UC7.8.1 - Visualizzazione anno accademico}
\end{figure}
\subsection{UC7.8.1.1 - Visualizzazione anno solare relativo ad un anno accademico}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	\item \textbf{Scopo e descrizione:} l'utente già riconosciuto dal sistema come amministratore visualizza un anno accademico, visualizzandoli sotto forma di numero;
	\item \textbf{Scenario principale:} l'amministratore richiede al sistema un anno accademico per visualizzarlo ed eventualmente compiere operazioni su di esso;
	\item \textbf{Precondizione:} il sistema riconosce l'utente come amministratore, il quale richiede le informazioni di un determinato anno accademico;
	\item \textbf{Postcondizione:} il sistema visualizza l'anno solare per l'anno accademico indicatogli.
\end{itemize}
...
\end{figure}
\subsection{UC7.9.1 - Visualizzazione professore}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	\item \textbf{Scopo e descrizione:} l'amministratore visualizza le informazioni basilari di un professore per poter determinare se associarlo all'esame precedentemente indicato;
	\item \textbf{Scenario principale:} all'amministratore vengono fornite le informazioni basilari riguardanti il professore indicato;
	\item \textbf{Precondizione:} il sistema riconosce l'utente come amministratore e riceve una richiesta di visualizzazione delle informazioni basilari relative al professore per poterlo eventualmente assegnare ad un dato esame precedentemente indicato; 
	\item \textbf{Postcondizione:} il sistema fornisce per il professore le relative informazioni.
\end{itemize}
\begin{figure}[H]
\centering
\includegraphics[width=0.7\linewidth]{UC7_9_1.jpg}
\caption{UC7.9.1 - Visualizzazione professore}
\label{UC7.9.1 - Visualizzazione professore}
\end{figure}
\subsection{UC7.9.1.1 - Visualizzazione nome professore}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	\item \textbf{Scopo e descrizione:} l'amministratore visualizza il nome del professore indicatogli per poter determinare se associarlo o meno all'esame precedentemente indicato;
	\item \textbf{Scenario principale:} all'amministratore viene fornito il nome del professore indicatogli;
	\item \textbf{Precondizione:} il sistema riconosce l'utente come amministratore e riceve una richiesta di visualizzazione delle informazioni del professore per poter determinare se è quello che desidera assegnare al dato esame; 
	\item \textbf{Postcondizione:} il sistema fornisce per il nome del professore indicato.
\end{itemize}
\subsection{UC7.9.1.2 - Visualizzazione cognome professore}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	\item \textbf{Scopo e descrizione:} l'amministratore visualizza il cognome del professore indicatogli per poter determinare se associarlo o meno all'esame precedentemente indicato;
	\item \textbf{Scenario principale:} all'amministratore viene fornito il cognome del professore indicatogli;
	\item \textbf{Precondizione:} il sistema riconosce l'utente come amministratore e riceve una richiesta di visualizzazione delle informazioni del professore per poter determinare se è quello che desidera assegnare al dato esame; 
	\item \textbf{Postcondizione:} il sistema fornisce per il cognome del professore indicato.
\end{itemize}
\subsection{UC7.9.1.3 - Visualizzazione indirizzo professore}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	\item \textbf{Scopo e descrizione:} l'amministratore visualizza l'indirizzo del professore indicatogli per poter determinare se associarlo o meno all'esame precedentemente indicato;
	\item \textbf{Scenario principale:} all'amministratore viene fornito l'indirizzo del professore indicatogli;
	\item \textbf{Precondizione:} il sistema riconosce l'utente come amministratore e riceve una richiesta di visualizzazione delle informazioni del professore per poter determinare se è quello che desidera assegnare al dato esame; 
	\item \textbf{Postcondizione:} il sistema fornisce per l'indirizzo del professore indicato.
\end{itemize}
...
\end{figure}
\subsection{UC8.1.1 - Visualizzazione esame}
\begin{itemize}
	\item \textbf{Attori primari:} professore;
	\item \textbf{Scopo e descrizione:} vengono visualizzate le informazioni basilari relative ad un esame richiesto; 
	\item \textbf{Precondizione:} il sistema riconosce l'utente come professore e riceve una richiesta di visualizzazione delle informazioni di un esame; 
	\item \textbf{Postcondizione:} il sistema fornisce al professore le informazioni basilari dell'esame indicatogli.
\end{itemize}
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{UC8_1_1.jpg}
	\caption{UC8.1.1 - Visualizzazione esame}
	\label{UC8.1.1 - Visualizzazione esame}
\end{figure}
\subsection{UC8.1.1.1 - Visualizzazione sigla esame}
\begin{itemize}
	\item \textbf{Attori primari:} professore;
	\item \textbf{Scopo e descrizione:} il professore visualizza la sigla dell'esame indicato;
	\item \textbf{Scenario principale:} il sistema mostra la sigla dell'esame indicato;
	\item \textbf{Precondizione:} il sistema riconosce l'utente come professore e riceve una richiesta di visualizzazione di un esame; 
	\item \textbf{Postcondizione:} il sistema fornisce al professore la sigla dell'esame richiesto.
\end{itemize}
\subsection{UC8.1.1.2 - Visualizzazione sigla del corso di laurea associato}
\begin{itemize}
	\item \textbf{Attori primari:} professore;
	\item \textbf{Scopo e descrizione:} il professore visualizza la sigla del corso di laurea che contiene l'esame indicato;
	\item \textbf{Scenario principale:} il sistema mostra la sigla del corso di laurea che contiene l'esame indicato;
	\item \textbf{Precondizione:} il sistema riconosce l'utente come professore e riceve una richiesta di visualizzazione di un esame; 
	\item \textbf{Postcondizione:} il sistema fornisce al professore la sigla del corso di laurea che contiene l'esame indicato.
\end{itemize}
...
\end{figure}
\subsection{UC8.2.1 - Visualizzazione singolo studente}
\begin{itemize}
	\item \textbf{Attori primari:} professore;
	\item \textbf{Scopo e descrizione:} il professore visualizza le informazioni basilari di uno studente;
	\item \textbf{Scenario principale:} il professore richiede al sistema le informazioni basilari di uno studente per poterle visualizzare ed eventualmente compiere altre operazioni su di esso;
	\item \textbf{Precondizione:} il sistema riconosce l'utente nel ruolo di professore e riceve la richiesta di visualizzazione delle informazioni di uno studente;
	\item \textbf{Postcondizione:} il sistema offre al professore le informazioni basilari dello studente indicato.
\end{itemize}
\begin{figure}[H]
\centering
\includegraphics[width=0.7\linewidth]{UC8_2_1.jpg}
\caption{UC8.2.1 - Visualizzazione singolo studente}
\label{UC8.2.1 - Visualizzazione singolo studente}
\end{figure}
\subsection{UC8.2.1.1 - Visualizzazione indirizzo dello studente}
\begin{itemize}
	\item \textbf{Attori primari:} professore;
	\item \textbf{Scopo e descrizione:} il professore visualizza l'\citGloss{indirizzo} della rete \citGloss{Ethereum} riguardante lo studente desiderato;
	\item \textbf{Scenario principale:} il professore richiede al sistema le informazioni di un determinato studente per poterne visualizzarne l'\citGloss{indirizzo} ed eventualmente compiere altre operazioni su di esso;
	\item \textbf{Precondizione:} il sistema riconosce l'utente nel ruolo di professore e riceve la richiesta di visualizzazione di un studente;
	\item \textbf{Postcondizione:} il sistema offre al professore l'indirizzo relativo all'utente approvato indicato.
\end{itemize}
\subsection{UC8.2.1.2 - Visualizzazione nomi degli studenti dell'esame}
\begin{itemize}
	\item \textbf{Attori primari:} professore;
	\item \textbf{Scopo e descrizione:} il professore visualizza il nome dello studente desiderato;
	\item \textbf{Scenario principale:} il professore richiede al sistema le informazioni di un determinato studente per poterne visualizzarne il nome ed eventualmente compiere altre operazioni su di esso;
	\item \textbf{Precondizione:} il sistema riconosce l'utente nel ruolo di professore e riceve la richiesta di visualizzazione di un studente;
	\item \textbf{Postcondizione:} il sistema offre al professore il nome relativo all'utente approvato indicato.
\end{itemize}
\subsection{UC8.2.1.3 - Visualizzazione cognomi degli studenti dell'esame}
\begin{itemize}
	\item \textbf{Attori primari:} professore;
	\item \textbf{Scopo e descrizione:} il professore visualizza il cognome dello studente desiderato;
	\item \textbf{Scenario principale:} il professore richiede al sistema le informazioni di un determinato studente per poterne visualizzarne il cognome ed eventualmente compiere altre operazioni su di esso;
	\item \textbf{Precondizione:} il sistema riconosce l'utente nel ruolo di professore e riceve la richiesta di visualizzazione di un studente;
	\item \textbf{Postcondizione:} il sistema offre al professore il cognome relativo all'utente approvato indicato.
\end{itemize}
...
\subsection{UC9.1.1 - Visualizzazione esame}
\begin{itemize}
	\item \textbf{Attori primari:} studente;
	\item \textbf{Scopo e descrizione:} vengono visualizzate le informazioni basilari relative ad un esame richiesto; 
	\item \textbf{Precondizione:} il sistema riconosce l'utente come studente e riceve una richiesta di visualizzazione delle informazioni di un esame; 
	\item \textbf{Postcondizione:} il sistema fornisce allo studente le informazioni basilari dell'esame indicatogli.
\end{itemize}
\begin{figure}[H]
\centering
\includegraphics[width=1.0\linewidth]{UC9_1_1.jpg}
\caption{UC9.1.1 - Visualizzazione esame}
\label{fig:UC9.1.1 - Visualizzazione esame}
\end{figure}
\subsection{UC9.1.1.1 - Visualizzazione sigla dell'esame}
\begin{itemize}
	\item \textbf{Attori primari:} studente;
	\item \textbf{Scopo e descrizione:} lo studente visualizza la sigla dell'esame indicato;
	\item \textbf{Scenario principale:} il sistema mostra la sigla dell'esame indicato;
	\item \textbf{Precondizione:} il sistema riconosce l'utente come studente e riceve una richiesta di visualizzazione di un esame; 
	\item \textbf{Postcondizione:} il sistema fornisce allo studente la sigla dell'esame richiesto.
\end{itemize}
\subsection{UC9.1.1.2 - Visualizzazione numero di crediti dell'esame}
\begin{itemize}
	\item \textbf{Attori primari:} studente;
	\item \textbf{Scopo e descrizione:} lo studente visualizza il numero di crediti dell'esame indicato;
	\item \textbf{Scenario principale:} il sistema mostra il numero di crediti dell'esame indicato;
	\item \textbf{Precondizione:} il sistema riconosce l'utente come studente e riceve una richiesta di visualizzazione di un esame; 
	\item \textbf{Postcondizione:} il sistema fornisce allo studente il numero di crediti dell'esame richiesto.
\end{itemize}
\subsection{UC9.1.1.3 - Visualizzazione obbligatorietà dell'esame}
\begin{itemize}
	\item \textbf{Attori primari:} studente;
	\item \textbf{Scopo e descrizione:} lo studente visualizza l'obbligatorietà dell'esame indicato;
	\item \textbf{Scenario principale:} il sistema mostra l'obbligatorietà dell'esame indicato;
	\item \textbf{Precondizione:} il sistema riconosce l'utente come studente e riceve una richiesta di visualizzazione di un esame; 
	\item \textbf{Postcondizione:} il sistema fornisce allo studente l'obbligatorietà dell'esame richiesto.
\end{itemize}
\subsection{UC9.1.1.4 - Visualizzazione della valutazione dell'esame}
\begin{itemize}
	\item \textbf{Attori primari:} studente;
	\item \textbf{Scopo e descrizione:} lo studente visualizza la valutazione dell'esame indicato;
	\item \textbf{Scenario principale:} il sistema mostra la valutazione dell'esame indicato;
	\item \textbf{Precondizione:} il sistema riconosce l'utente come studente e riceve una richiesta di visualizzazione di un esame; 
	\item \textbf{Postcondizione:} il sistema fornisce allo studente la valutazione dell'esame richiesto.
\end{itemize}
...
\begin{figure}[H]
\centering
\includegraphics[width=1.0\linewidth]{UC9_2.jpg}
\caption{UC9.2 - Visualizzazione degli esami opzionali e dei loro crediti}
\label{fig:UC9.2 - Visualizzazione degli esami opzionali e dei loro crediti}
\end{figure}
\subsection{UC9.2.1 - Visualizzazione esame sottoscrivibile}
\begin{itemize}
	\item \textbf{Attori primari:} studente;
	\item \textbf{Scopo e descrizione:} vengono visualizzate le informazioni basilari relative ad un esame sottoscrivibile richiesto, in modo da permettere eventualmente una sottoscrizione ad esso; 
	\item \textbf{Precondizione:} il sistema riconosce l'utente come studente e riceve una richiesta di visualizzazione delle informazioni di un esame sottoscrivibile; 
	\item \textbf{Postcondizione:} il sistema fornisce allo studente le informazioni basilari dell'esame indicatogli.
\end{itemize}
\begin{figure}[H]
\centering
\includegraphics[width=1.0\linewidth]{UC9_2_1.jpg}
\caption{UC9.2.1 - Visualizzazione esame sottoscrivibile}
\label{fig:UC9.2.1 - Visualizzazione esame sottoscrivibile}
\end{figure}
\subsection{UC9.2.1.1 - Visualizzazione sigla dell'esame sottoscrivibile}
\begin{itemize}
	\item \textbf{Attori primari:} studente;
	\item \textbf{Scopo e descrizione:} lo studente visualizza la sigla dell'esame indicato;
	\item \textbf{Scenario principale:} il sistema mostra la sigla dell'esame indicato;
	\item \textbf{Precondizione:} il sistema riconosce l'utente come studente e riceve una richiesta di visualizzazione di un esame sottoscrivibile;
	\item \textbf{Postcondizione:} il sistema fornisce allo studente la sigla dell'esame richiesto.
\end{itemize}
\subsection{UC9.2.1.2 - Visualizzazione numero di crediti dell'esame sottoscrivibile}
\begin{itemize}
	\item \textbf{Attori primari:} studente;
	\item \textbf{Scopo e descrizione:} lo studente visualizza il numero di crediti dell'esame indicato;
	\item \textbf{Scenario principale:} il sistema mostra il numero di crediti dell'esame indicato;
...
\subsection{UC10.2.1 - Visualizzazione singolo amministratore}
\begin{itemize}
	\item \textbf{Attori primari:} università;
	\item \textbf{Scopo e descrizione:} l'utente che rappresenta l'università visualizza un amministratore;
	\item \textbf{Scenario principale:} l'utente che rappresenta l'università richiede al sistema un amministratore per poterne consultare i dettagli ed eventualmente compiere altre operazioni su di esso;
	\item \textbf{Precondizione:} il sistema riconosce l'utente nel ruolo di rappresentante dell'università, il quale richiede la visualizzazione dei dettagli di un amministratore; 
	\item \textbf{Postcondizione:} il sistema fornisce i dettagli dell'amministratore.
\end{itemize}


\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{UC10_2_1.jpg}
	\caption{UC10.2.1 - Visualizzazione singolo amministratore}
	\label{UC10.2.1 - Visualizzazione singolo amministratore}
\end{figure}

\subsection{UC10.2.1.1 - Visualizzazione indirizzi degli amministratori}
\begin{itemize}
	\item \textbf{Attori primari:} università;
...
\begin{itemize}
	...
	\item \textbf{Flusso principale degli eventi:}
	\begin{enumerate}
		\item L'utente che rappresenta l'università  visualizza la lista degli amministratori [UC10.2.1];
		\item L'utente che rappresenta l'università, una volta ottenuta la lista degli amministratori, individua quale desidera rimuovere [UC10.2.1];
		\item L'utente che rappresenta l'università richiede al sistema l'eliminazione dell'amministratore [UC10.3].5
	\end{enumerate}
	\item \textbf{Precondizione:} il sistema riconosce l'utente nel ruolo di rappresentante dell'università e ha precedentemente fornito la lista degli amministratori presenti [UC10.2.1]; 
