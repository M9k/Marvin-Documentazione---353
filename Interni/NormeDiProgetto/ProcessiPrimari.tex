...
All'inizio verranno elencate delle norme generali a cui i \progri{} devono attenersi con qualsiasi linguaggio di programmazione utilizzato, mentre di seguito verranno elencate delle norme specifiche per i linguaggi JavaScript, JavaScript Syntax eXtension, Solidity e \citGloss{SCSS}.\\
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item \citGloss{Redux}: Jest\footnote{\nURI{https://facebook.github.io/jest/}};
