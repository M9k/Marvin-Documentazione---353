...
\begin{table}[H]
	\begin{center}
		\begin{tabu} to \textwidth {
			...
			\textbf{MPS002} & -9,92\% & Dovuto a maggior verifica e analisi rispetto pianificazione & Accettato \\
...
\begin{table}[H]
	\begin{center}
		\begin{tabu} to \textwidth {
			...
			\textbf{PROC002} & 0 & Sarà istanziato dalla consenga documenti revisione requisiti per creazione \citGloss{proof of concept} \\ 
