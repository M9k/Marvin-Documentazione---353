...
\chapter{Resoconto}
\begin{enumerate}
	\item \textbf{Visione contratto solidity:} l'incontro si è aperto con il gruppo \gruppo che ha esposto una bozza di contratto solidity per discutere del costo del caricamento di una serie di contratti su \citGloss{blockchain} etherium;
