...
\begin{longtable}[H]{p{2.6cm}p{2.5cm}p{5cm}p{2cm}}
	...
	R0F3.4.3 & Obbligatorio & L'amministratore può ottenere il nome ed il cognome di quale professore è assegnato a un determinato esame & Interno \\
...
\begin{longtable}[H]{p{2cm}p{5cm}p{5cm}}
	...
	UC7.7.1 & Visualizzazione sigle esami per \citGloss{corso di laurea} & R0F3.4.1 \\
	...
	UC7.8.1 & Visualizzazione sigle esami & R0F3.4.1 \\
	...
	%TODO ----------
	UC7.10 & Associazione professore a esame & R0F3.4.4 \\
	UC7.10.1 & Visualizzazione lista di esami non ancora assegnati & R0F3.4.4 \\ 
	UC7.10.2 & Visualizzazione lista professori selezionato un esame & R0F3.4.4 \\ 
	UC7.10.3 & Associazione professore all'esame & R0F3.4.4 \\ 
	%TODO ----------
...
\begin{longtable}[H]{p{2cm}p{5.2cm}p{5cm}}
	...
	R0F3.4.3 & L'amministratore può ottenere il nome ed il cognome di quale professore è assegnato a un determinato esame & \makecell[tl]{
		Interno \\ 
		UC7.7.3 \\
		UC7.7.4 \\
		UC7.9.4 \\
	...
	R0F3.4.4  & L'amministratore può associare ad un esame il relativo professore & \makecell[tl]{
		...
		UC7.10 \\ 
		UC7.10.1 \\
		UC7.10.2 \\  %TODO correggerli dopo aver sistemato UC7.10
		UC7.10.3 \\ 	
	} \\
