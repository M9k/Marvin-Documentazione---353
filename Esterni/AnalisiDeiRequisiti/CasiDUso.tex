...
\begin{itemize}
	...
	\item \textbf{Estensioni:}
		...
		\end{enumerate}
	\item \textbf{Precondizione:} il sistema ha identificato l'utente come amministratore e ha fornito una lista di \citGloss{anni accademici} [UC7.10];
...
% TODO 7.1.1 - Inserimento sigla nuovo corso o qualcosa di simile - spostare UC 7.2 in UC 7.1.2 ?
...
% UC 7.5.1 inserimento nome, 7.5.2 inserimento crediti, 7.5.3 inserimento obbligatorietà, UC 7.6 come 7.5.4
...
\begin{itemize}
	...
	\item \textbf{Precondizione:} il sistema ha ricevuto come richiesta la creazione di un esame utilizzando un nome che non rispetta i \citGloss{requisiti} indicati; 
...
% TODO UC8.3.1 inserimento voto numerico
...
\begin{itemize}
	...
	\item \textbf{Postcondizione:} il sistema ha registrato il voto all'interno della \citGloss{blockchain}.
\end{itemize}
...
% TODO specificare in UC9.4.1 etc quali informazini (somma dei crediti, crediti da raggiungere, crediti che gli servono, crediti acquisibili con gli esami ai quali è iscritto)
