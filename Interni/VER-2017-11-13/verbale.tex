...
\begin{enumerate}
	...
	\begin{itemize}
		...
		\item \textbf{\citGloss{Slack}:} scelto per la comunicazione, perché permette la creazione di diversi canali e l'integrazione con \citGloss{GitHub} e \citGloss{Asana}.
	\end{itemize}
