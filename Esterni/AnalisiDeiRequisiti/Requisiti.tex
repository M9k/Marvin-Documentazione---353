...
I \citGloss{requisiti} vengono classificati ed assegnati loro un identificativo univoco secondo quanto definito nel documento \textit{Norme di progetto v1.0.0}.
...
\begin{longtable}[H]{p{2.6cm}p{2.5cm}p{5cm}p{2cm}}
	...
	R0F3.3 & Obbligatorio & L'amministratore può aggiungere dei corsi di laurea ad ogni \citGloss{anno accademico} & Capitolato \\  
	%R2F3.4 & Opzionale & L'amministratore può rimuovere corsi di laurea da ogni \citGloss{anno accademico} & Interni \\  
	R0F3.4 & Obbligatorio & L'amministratore può gestire i corsi di laurea relativi agli anni accademici & Capitolato \\  
	R0F3.4.1 & Obbligatorio & L'amministratore può creare un nuovo \citGloss{corso di laurea} a partire da un \citGloss{anno accademico} & Capitolato \\  
	R0F3.4.2 & Obbligatorio & L'amministratore può ottenere una lista di tutti i corsi di laurea dato un \citGloss{anno accademico} & Interno \\  
	R0F3.4.3 & Obbligatorio & L'amministratore può creare nuovi esami & Capitolato \\  
	R0F3.4.4 & Obbligatorio & L'amministratore può aggiungere degli esami ad ogni \citGloss{corso di laurea} & Capitolato \\  
	%R0F3.4.5 & Opzionale & L'amministratore può rimuovere degli esami da un \citGloss{corso di laurea} & Interno \\  
	R0F3.4.5 & Obbligatorio & L'amministratore può ottenere una lista di tutti gli esami dato il \citGloss{corso di laurea} & Interno \\  
...
\begin{longtable}[H]{p{2.5cm}p{2.5cm}p{5cm}p{2cm}}
	...
	R0V5 & Obbligatorio & L'applicativo deve essere accessibile ed utilizzabile dal \citGloss{browser} Mozilla \citGloss{Firefox} a partire dalla versione X & Interno \\   %TODO: definire versione
	R0V6 & Obbligatorio & L'applicativo deve essere accessibile ed utilizzabile dal \citGloss{browser} Google \citGloss{Chrome} a partire dalla versione X & Interno \\   %TODO: definire versione
...
\begin{longtable}[H]{p{2cm}p{5cm}p{5cm}}
	...
	UC5.2.3 & Aggiunta di un \citGloss{corso di laurea} ad un \citGloss{anno accademico} & R0F3.3 \\  
	UC5.2.4 & Visualizzazione messaggio anno malformato & R0F3.1 \\  
	UC5.2.5 & Visualizzazione messaggio di \citGloss{anno accademico} già presente & R0F3.1 \\  
	UC5.2.6 & Visualizzazione messaggio anno non compilato &  R0F3.1 \\  
	UC5.3 & Gestione corsi di laurea &  R0F3.4 \\   
	UC5.3.1 & Creazione \citGloss{corso di laurea} &  R0F3.4.1 \\  
	...
	UC5.3.4 & Visualizzazione lista corsi di laurea per \citGloss{anno accademico} & R0F3.4.2  \\  
	...
	UC5.3.7 & Visualizzazione lista esami per \citGloss{corso di laurea} & R0F3.4.5 \\  
	...
	%UC5.3.12 & Rimozione \citGloss{corso di laurea} da \citGloss{anno accademico} & R2F34 \\  
...
\begin{longtable}[H]{p{2cm}p{5.2cm}p{5cm}}
	...
	R0F3.3 &  L'amministratore può aggiungere dei corsi di laurea ad ogni \citGloss{anno accademico} & \makecell[tl]{
		Capitolato \\ 
		UC5.2.3
	} \\  
	%R2F3.4 &  L'amministratore può rimuovere corsi di laurea da ogni \citGloss{anno accademico} & Interno} \\  
	R0F3.4 &  L'amministratore può gestire i corsi di laurea relativi agli anni accademici & \makecell[tl]{
		Capitolato \\ 
		UC5.3 
	} \\  
	R0F3.4.1 &  L'amministratore può creare un nuovo \citGloss{corso di laurea} a partire da un \citGloss{anno accademico} & \makecell[tl]{
		Capitolato \\ 
		UC5.3.1 \\  
		UC5.3.2
	} \\  
	R0F3.4.2 &  L'amministratore può ottenere una lista di tutti i corsi di laurea dato un \citGloss{anno accademico} & \makecell[tl]{
		Interno \\ 
		UC5.3.3 \\  
		UC5.3.4
	} \\  
	...
	R0F3.4.4 &  L'amministratore può aggiungere degli esami ad ogni \citGloss{corso di laurea} & \makecell[tl]{
		Capitolato \\ 
		UC5.3.9
	} \\  
	%R0F3.4.5 &  L'amministratore può rimuovere degli esami da un \citGloss{corso di laurea} & Interno \\ UC5.3.10} \\  
	R0F3.4.5 &  L'amministratore può ottenere una lista di tutti gli esami dato il \citGloss{corso di laurea} & \makecell[tl]{
		Interno \\ 
		UC5.3.7 \\ 
		UC5.3.8
	} \\  
