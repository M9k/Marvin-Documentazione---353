...
\begin{longtable}[H]{p{2cm}p{5cm}p{5cm}}
	...
	UC7.3.1 & Visualizzazione sigle dei \citGloss{corsi di laurea} & R0F3.2 \\
	UC7.3.2 & Visualizzazione anni accademici associati ai \citGloss{corsi di laurea} & R0F3.2 \\
	UC7.4 & Visualizzazione lista corsi di laurea per \citGloss{anno accademico} & R0F3.2  \\
	UC7.4.1 & Visualizzazione sigle dei corsi di laurea per \citGloss{anno accademico} & R0F3.2  \\
	...
	UC7.7.1 & Visualizzazione nomi esami per \citGloss{corso di laurea} & R0F3.4 \\
	UC7.7.2 & Visualizzazione crediti esami per \citGloss{corso di laurea} & R0F3.4 \\
	UC7.7.3 & Visualizzazione nomi dei professori associati agli esami per \citGloss{corso di laurea} se presenti & R0F3.4 \\
	UC7.7.4 & Visualizzazione cognomi dei professori associati agli esami per \citGloss{corso di laurea} se presenti & R0F3.4 \\
	UC7.8 & Visualizzazione lista esami & R0F3.4 \\
	UC7.8.1 & Visualizzazione nomi esami & R0F3.4 \\
	UC7.8.2 & Visualizzazione crediti esami & R0F3.4 \\
	UC7.8.3 & Visualizzazione sigle \citGloss{corsi di laurea} associati ad esami se presenti & R0F3.4 \\
	UC7.8.4 & Visualizzazione nomi dei professori associati agli esami se presenti & R0F3.4 \\
	UC7.8.5 & Visualizzazione cognomi dei professori associati agli esami se presenti & R0F3.4 \\
	UC7.9 & Visualizzazione dettagli esame & R0F3.4.1 \\
	UC7.9.1 & Visualizzazione nome esame & R0F3.4.1 \\
	UC7.9.2 & Visualizzazione crediti esame & R0F3.4.1 \\
	UC7.9.3 & Visualizzazione corso di laurea associato all'esame se presente & R0F3.4.1 \\
	UC7.9.4 & Visualizzazione nome del professore associato all'esame se presente & R0F3.4.1 \\
	UC7.9.5 & Visualizzazione cognome del professore associato all'esame se presente & R0F3.4.1 \\
	UC7.9.6 & Visualizzazione numero di studenti iscritti all'esame & R0F3.4.1 \\
	...
	UC7.11 & Visualizzazione di tutti gli anni accademici & R0F12.3 \\
	UC7.11.1 & Visualizzazione anni solari relativi agli anni accademici & R0F12.3 \\
...
\begin{longtable}[H]{p{2cm}p{5.2cm}p{5cm}}
	...
	R0F12.3 &  L'università e gli amministratori possono ottenere una lista degli anni accademici & \makecell[tl]{
		Interno \\ 
		UC6.2 \\
		UC6.2.1 \\
		UC7.11 \\
