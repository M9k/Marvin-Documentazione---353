...
\end{itemize}
%TODO Questo elenco non mi convince tanto. In teoria soddisfa le norme, ma in tutti gli altri elenchi dopo :(2 punti) nei vari item del elenco, abbiamo la prima parola che inzia con una lettera minuscola qui invece no. 
