...
\subsection{UC5.1 - Visualizzazione lista di studenti}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
...
\end{itemize}
\subsection{UC6 - Visualizzazione lista di professori}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	...
	\item \textbf{Postcondizione:} l'amministratore ottiene la lista.
\end{itemize}
\subsection{UC7 - Visualizzazione lista di utenti in attesa di abilitazione}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
...
\begin{itemize}
	...
	\item \textbf{Estensioni:}
	\begin{enumerate}
		\item Se l'amministratore inserisce un anno non numerico viene mostrato un messaggio d'errore relativo alla invalidità del dato fornito [UC6.4];
		\item Se l'amministratore inserisce un'anno già presente nel sistema viene mostrato un messaggio d'errore relativo alla non univocità dell'anno [UC6.5];
		\item Se l'amministratore lascia il campo vuoto l'utente viene avvisato con un relativo messaggio d'errore [UC6.6].
	\end{enumerate}
...
\begin{itemize}
	...
	\item \textbf{Estensioni:}
		...
		\end{enumerate}
	\item \textbf{Precondizione:} l'amministratore, dopo aver ottenuto una lista di \citGloss{anni accademici} [UC6.2] ed indicatone uno desidera inserire un nuovo corso di laurea; 
...
\begin{itemize}
	...
	\item \textbf{Precondizione:} l'amministratore ha visualizzato una lista di anni accademici [UC6.2] e vuole visualizzare i corsi di laurea all'interno di uno di essi; 
...
\begin{figure}[H]
	...
	\caption{UC7.10 - Associazione professore a esame}
	\label{fig:UC7.10 - Associazione professore a esame}
\end{figure}
