...
\begin{enumerate}
\item \textbf{Codebase:} una sola codebase sotto \citGloss{controllo di versione}, tanti deploy;
...
\subsection{Codebase}
L'app deve sempre attenersi al \citGloss{controllo di versione}. Esiste una relazione uno-a-uno tra codebase e applicazione, ma ci saranno comunque tanti deploy. In uno stesso istante possono esistere più versioni della codebase.\\
...
%TODO Concorrenza: tanti termini da aggiungere nel glossario. Esempio i demoni,Unix,crash, SysVinit, Systemd, Http ecc... 
...
\end{itemize}
%TODO Termini da agiungere al glossario. Esempio SQLLite, PostgreSQL, deploy(?), backing service ecc..
...
%TODO Termini da aggiunger al glossario. Esempio stream, logfile,log(?), alert.
\subsection{Log}
...
\end{itemize}
%TODO Termini da aggiungere al glossario. Esempio script,database, realese,codebase,shell, REPL, out of the box(??),SSH ecc..
