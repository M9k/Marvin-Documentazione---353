...
Un aspetto del capitolato giudicato negativo da parte del gruppo è l'utilizzo di una blockchain privata, che rappresenta un dettaglio controverso, in quanto la maggior parte delle catene di blocchi più diffuse (Bitcoin, Litecoin ed \citGloss{Ethereum}) sono pubbliche.
\end{document}