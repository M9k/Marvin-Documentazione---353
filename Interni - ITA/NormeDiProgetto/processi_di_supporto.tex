...
\begin{document}
	...
	E' stata realizzata solo una repository durante la fase di RR ossia quella relativa alla documentazione denominata "Documentazione 353", si prevede inoltre di creare ulteriori repository per suddividere lo sviluppo e la codifica dell'applicazione del progetto. \\\\
	...
	Nella root della repository è stato messo invece un file .sh gestito tramite Travis CI che controlla automaticamente gli errori in tutti i documenti presenti e compila un log con i risultati ottenuti.
	...
	\begin{itemize}
		...
		\end{itemize}
		In questo modo il repository locale risulta aggiornato rispetto il repository remoto, mantenendo le modifiche personali apportate;
	...
	\begin{itemize}
		...
		\item \textbf{Documenti:} Per il controllo dei documenti prodotti utilizzeremo le funzionalità di Texstudio assieme a script bash eseguiti automaticamente da un bot per controllare che non ci siano errori nei file LaTex, per assicurarsi che il Glossario non presenti mancanze o duplicati e verificare l'assenza di errori ortografici;
