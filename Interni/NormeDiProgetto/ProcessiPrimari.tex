...
\begin{enumerate}
	\item \textbf{Nome componente:} deve essere univoco, scritto seguendo la notazione CamelCase, in inglese;
...
\paragraph{Redux}
Le sagas Redux sono rappresentate attraverso un rettangolo diviso orizzontalmente in quattro sezioni:
\begin{enumerate}
	\item \textbf{Nome saga:} deve essere univoco, scritto seguendo la notazione CamelCase, in inglese;
	\item \textbf{Types:} deve elencare la lista secondo la notazione 
	\begin{center}
		\texttt{modifier NAME\_TYPE: type}
	\end{center}
	\item \textbf{Sagas:} elenca la lista di metodi secondo la notazione 
	\begin{center}
		\texttt{modifier methodName(types): type}
	\end{center}
