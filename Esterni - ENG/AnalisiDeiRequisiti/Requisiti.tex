...
\begin{longtable}[H]{|p{2.5cm}|p{2.5cm}|p{5cm}|p{2cm}|}
	...
	%R0F3.4.5 & Opzionale & L'amministratore può rimuovere degli esami da un corso di laurea & Interno \\ \hline
...
\begin{longtable}[H]{|p{2cm}|p{5cm}|p{5cm}|}
	...
	%UC5.3.10 & Rimozione esame da un corso &  R0F3.4.5 \\ \hline
...
\begin{longtable}[H]{|p{2cm}|p{5.2cm}|p{5cm}|}
	...
	%R0F3.4.5 &  L'amministratore può rimuovere degli esami da un corso di laurea & Interno \\ UC5.3.10} \\ \hline
