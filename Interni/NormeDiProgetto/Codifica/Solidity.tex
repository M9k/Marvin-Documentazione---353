...
La graffa che chiude il corpo della funzione va chiusa allo stesso livello di indentazione della dichiarazione iniziale. %TODO: riformulare la frase togliendo le ripetizioni
\begin{center}{
\begin{minipage}{14cm}
{\begin{center}SI\end{center}}
\begin{Verbatim}[frame=single]
