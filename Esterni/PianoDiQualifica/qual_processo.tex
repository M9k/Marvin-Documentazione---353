...
Per garantire la correttezza per costruzione, il \citGloss{commit} effettuati dal gruppo devono essere frequenti e contenenti pochi cambiamenti, in modo da garantire un miglior controllo sul codice prodotto. Inoltre le \citGloss{build} effettuate con lo strumento di integrazione continua \citGloss{Travis} sono l'indicatore della correttezza e aderenza alle norme del codice.
\begin{itemize}
	...
	\item \textlink{MPS011TAB}{MPS011}{MPS011} Percentuale build fallite
\end{itemize}
...
\begin{table}[H]
	\begin{center}
		\begin{tabu} to \textwidth {
			...
			\textlink{MPS009}{MPS009TAB}{MPS009} & & & \\
			\item \textlink{MPS010}{MPS010TAB}{MPS010} & & & \\
			\item \textlink{MPS011}{MPS011TAB}{MPS011} & & & \\
