...
\end{itemize}
Il risultato di quest'analisi sarà il documento \adr \vruno{} redatto dagli Analisti,dopo essere stato verificato, al fine di:
\begin{itemize}
...
\begin{itemize}
	\item Tracciamento requisiti
	\item Creazione diagrammi UML
	\item Tracciamento dei test
	\item Scrittura del codice
