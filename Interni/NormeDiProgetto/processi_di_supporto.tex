...
\begin{document}
	...
	\begin{itemize}
		...
		\item \textbf{Metriche per i documenti:} per la verifica dei documenti è stata scelto l'indice di leggibilità secondo l'indice Gulpease che viene calcolato tramite funzione Latex.\\
	...
	Per quanto riguarda questa prima parte di progetto la verificati si è concentrata essenzialmente su documenti e diagrammi.
