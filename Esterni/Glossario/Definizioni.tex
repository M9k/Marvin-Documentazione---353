...
\newglossaryentry{QA}{
	name={QA},
	description={Acronimo per Quality Assurance, s'intende il team di verificatori che effettua l'analisi dinamica del software, specificatamente sui test ad alto livello.}
}
%FINE QA
...
\newglossaryentry{white-box}{
	name={white-box},
	description={Tipologia di test atta a verificare la struttura del codice, controllando ogni azione logica che il codice può/deve compiere.}
}
%FINE WHITE-BOX
...
\newglossaryentry{black-box}{
	name={black-box},
	description={Tipologia di test atta a verificare il comportamento del codice, forniti dei parametri di ingresso, si controllano quelli di uscita, ignorando la logica interno.}
}
%FINE BLACK-BOX
...
\newglossaryentry{BDD}{
	name={BDD},
	description={Variante del TDD per i test ad alto livello, la B si riferisce a behaviour, comportamento, indicando un focus, a livello di analisi sul comportamento del codice. La dialettica usata per la stesura dei test, per questa filosofia, si avvicina alla lingua parlata.}
}
%FINE BDD
