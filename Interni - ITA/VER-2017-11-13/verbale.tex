...
\begin{enumerate}
	...
	\begin{itemize}
		...
		\item \citGloss{Asana}: è stato scelta questa applicazione per predisporre una panoramica per il controllo dei task;
		\item \citGloss{GitHub}: scelto come strumento per il versionamento;
		\item \citGloss{Slack}: scelto per la comunicazione, perché permette la creazione di diversi canali e l'integrazione con \citGloss{GitHub} e \citGloss{Asana}.
	\end{itemize}
