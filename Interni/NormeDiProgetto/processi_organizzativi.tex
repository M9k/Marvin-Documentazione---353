...
\subparagraph{Standups:} per incentivare la continuità nel tempo dello sviluppo della commessa, si è scelto di utilizzare Standup Alice, un \citGloss{bot} per \emph{Slack} che consente la realizzazione giornaliera di \citGloss{standups}, permettendo al gruppo di seguire costantemente l'operato degli altri componenti e di confrontarsi nel caso sorgano dubbi o domande.
	...
	Il verificatore è una figura presente per tutta la durata del progetto. \`{E} responsabile delle attività di \citGloss{verifica}, che comprendono:
	\begin{itemize}
	...
	Il gruppo ha scelto servizio cloud \citGloss{Asana} poiché offre la possibilità di creare dei task ed assegnarli ai membri del gruppo 353, indicando anche la data di inizio e di fine in modo da consentire una pianificazione del lavoro da svolgere.\\
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1\linewidth]{../../common/images/TaskCreation}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1\linewidth]{../../common/images/AsanaFlow}
	\end{figure}
