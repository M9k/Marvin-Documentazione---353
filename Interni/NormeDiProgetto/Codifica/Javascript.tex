...
\begin{document}	
	...
	vanno utilizzati due (2) spazi per ogni livello di indentazione (in questo esempio viene usato il punto "." per rappresentare uno spazio d'indentazione).
...
non è stata utilizzata la nuova funzionalità \textquotedblleft ASI\textquotedblright\ o \textquotedblleft Automatic Semicolon Insertion\textquotedblright\ in quanto introdotta nello standard \citGloss{ECMA} 2018, mentre questo progetto fa riferimento allo standard 2017.\\ 
