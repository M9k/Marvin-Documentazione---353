...
\newacronym{corsi di laurea}{corso di laurea}{}
\newacronym{Corsi di laurea}{corso di laurea}{}
...
\newacronym{Wireframe}{wireframe}{}
\newacronym{Uml}{uml}{}
\newacronym{UML}{uml}{}
\newacronym{Web3.js}{web3.js}{}
\newacronym{Web3}{web3.js}{}
\newacronym{web3}{web3.js}{}
\newacronym{Hangouts}{hangouts}{}
...
\newglossaryentry{wireframe}{
	name={Wireframe},
	description={Scheletro del front-end dell’applicazione, dove viene assicurata la giusta posizione dei blocchi principali del contenuto, una corretta struttura delle informazioni e descritte le principali interazioni utente-interfaccia}
}
%FINE WIREFRAME
...
\newglossaryentry{web3.js}{
	name={Web3.js},
	description={Raccolta di librerie per interfacciarsi ad un nodo \citGloss{Ethereum} attraverso richieste \citGloss{RPC}}
}
%FINE WEB3
...
\newglossaryentry{RPC}{
	name={RPC},
	description={Remote Procedure Call, si riferisce all'attivazione da parte di un programma di una procedura o subroutine attivata su un computer diverso da quello sul quale il programma viene eseguito}
}
%FINE RPC
...
\newglossaryentry{hangouts}{
	name={Hangouts},
	description={Software di messaggistica istantanea e di VoIP sviluppato da Google. È disponibile per le piattaforme mobili Android e iOS e come estensione per il browser web Google Chrome}
}
%FINE HANGOUTS
...
\newglossaryentry{CamelCase}{
	name={CamelCase},
	description={
		La notazione a cammello o in inglese CamelCase è la pratica di scrivere parole composte o frasi unendo tutte le parole tra loro, ma lasciando le loro iniziali maiuscole. La prima lettera può essere sia maiuscola (es. CamelCase), che minuscola(camelCase)}
}
%FINE CAMELCASE

%INIZIO SAGAS
\newglossaryentry{Sagas}{
	name={Sagas},
	description={Middleware di Redux che si occupa, tramite chiamate asincrone, del recupero dei dati dalla blockchain. Le sagas sono direttamente connesse con i ducks, e fanno il dispatch delle action}
}
%FINE SAGAS

%INIZIO DUCKS
\newglossaryentry{Ducks}{
	name={Ducks},
	description={Singolo modulo che contiene tutte le funzionalità  di una parte logica di programma}
}
%FINE DUCKS
