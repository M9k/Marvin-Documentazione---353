...
\begin{enumerate}
	...
	\item \textbf{Utente in attesa di abilitazione} \\
	Ci si riferisce ad un utente in attesa di abilitazione quando l'utente ha passato la fase di registrazione ma non è ancora stato abilitato ai servizi dal personale amministrativo.
...
\begin{itemize}
	\item \textbf{Attori primari:} Utente in attesa di abilitazione;
...
\begin{itemize}
	...
	\begin{enumerate}
		...
		\item Se l'utente ha una chiave pubblica già registrata in un altro ruolo all'interno dell'università gli viene impedita la registrazione [UC3.6]
	\end{enumerate}
...
\begin{itemize}
	...
	\item \textbf{Postcondizione:} L'utente ottiene la lista desiderata.
\end{itemize}
%TODO: Assegna esame a corso, rimuovi esame da corso, UC5.3.3 nello specifico //Gianluca
