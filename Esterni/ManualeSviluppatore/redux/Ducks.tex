...
\begin{document}
	...
	Ducks are a proposal for bundling reducers, action types and actions in a single file. To have the possibility to extend and reuse our ducks, we decided to use extensible-duck\footnote{\nURI{https://github.com/investtools/extensible-duck}} implementation.
