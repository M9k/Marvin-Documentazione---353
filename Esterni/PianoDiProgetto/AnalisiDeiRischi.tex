...
\begin{longtabu} to \linewidth { >{\centering}m{.17\linewidth} >{\raggedright}m{.33\linewidth} >{\raggedright}m{0.25\linewidth} >{\centering}m{0.17\linewidth} }
	...
	&  \multicolumn{3}{m{0.8075\linewidth}}{
	Si è verificato un piccolo problema legato all'ambiente git. Alcuni membri non avendo esperienza con quest'ambiente, hanno avuto necessità di dedicare più tempo per imparare ad utilizzare questa tecnologia.
		}\\ 
	%Fine codice per Attualizzazione
