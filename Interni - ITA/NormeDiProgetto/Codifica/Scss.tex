...
\subsubsection{Scss}
In questa sotto-sezione vengono elencate le norme tratte dalla \textbf{Airbnb\\ CSS/Scss Styleguide}\footnote{\href{https://github.com/airbnb/css}{https://github.com/airbnb/css}}.
...
\begin{enumerate}
	\item proprietà standard: vanno dichiarate per prime e in ordine alfabetico;
\begin{center}{
\begin{minipage}{5cm}
\begin{Verbatim}[frame=single]
.btn-green {
