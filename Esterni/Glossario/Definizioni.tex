...
\newglossaryentry{Sagas}{
	name={Sagas},
	description={Le Redux Sagas funzionano come thread separati nella propria applicazione che sono responsabili dei side effect}
}
%FINE SAGAS
...
\newglossaryentry{Ducks}{
	name={Ducks},
	description={Moduli Redux fatti per riunire funzionalità solitamente esportate assieme}
}
%FINE DUCKS
