...
\begin{itemize}
	\item Particolari raccomandazioni sono state fatte riguardo alla scrittura di codice in Javascript: è stato richiesto l'utilizzo del \citGloss{Linting} fin da subito;
