...
\end{center}
Le stesse regole valgono per strutture di controllo come \texttt{if}, \texttt{else}, \texttt{while} e \texttt{for}.\\
...
Per dichirazioni brevi, la dichiarazione della funzione va lasciato uno spazio bianco prima dell'apertura della graffa sulla stessa linea. La graffa che chiude il corpo della funzione va chiusa allo stesso livello di indentazione della dichiarazione iniziale.
\begin{center}{
\begin{minipage}{14cm}
{\begin{center}SI\end{center}}
\begin{Verbatim}[frame=single]
...
\end{center}
Dichiarare stringhe solo utilizzando i doppi apici.
\begin{center}{
\begin{minipage}{10cm}
{\begin{center}SI\end{center}}
\begin{Verbatim}[frame=single]
...
\begin{itemize}
	...
	%TODO costanti con underscore
	\item Costanti: seguono il %CAPITAL_CASE_WITH_UNDERSCORE style.\\
	\textbf{es.} %MAX_BLOCKS, TOKEN_NAME, TOKEN_TICKET;
