...
\begin{longtable}[H]{|p{2.5cm}|p{2.5cm}|p{5cm}|p{2cm}|}
	...
	R0F10 & Obbligatorio & L'università deve poter gestire gli amministratori & VE171209 \\ \hline %TODO: controllare se il nome del verbale coindice
	R0F10.1 & Obbligatorio & L'università deve poter aggiungere amministratori & VE171209 \\ \hline %TODO: controllare se il nome del verbale coindice
	R0F10.2 & Obbligatorio & L'università deve poter rimuovere amministratori & VE171209 \\ \hline %TODO: controllare se il nome del verbale coindice
	R0F10.3 & Obbligatorio & L'università deve poter ottenere la lista di tutti gli amministratori & Interno \\ \hline 
...
\begin{longtable}[H]{|p{2cm}|p{5cm}|p{5cm}|}
	...
	& & R0F3.5.2 \\
	& & R0F3.6 \\
	%TODO: per 3.7 bisogna chiedere come intendono tutta questa cosa
	& & R0F3.8 \\
	& & R0F5.1.1 \\
	& & R0F5.1.2 \\
	& & R0F5.1.3 \\
