...
\begin{itemize}
	...
	\item \textbf{Estensioni:}
		...
		\end{enumerate}
	\item \textbf{Precondizione:} L'utente vuole inserire il proprio nome e far controllare che la chiave da lui fornita sia presente e valida;
	\item \textbf{Postcondizione:} L'utente ha inserito il proprio nome nel campo fornito dal sistema e controllato la validità della sua chiave;
\end{itemize}	
...
\begin{itemize}
	...
	\item \textbf{Postcondizione:} L'utente ha selezionato la sua categoria nel campo fornito dal sistema, se la categoria scelta è quella del professore l'utente terminal la procedura di registrazione;
\end{itemize}
