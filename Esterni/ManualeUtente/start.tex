...
\section{The help page}
 This page has all the information about how to use Metamask for new users. You can open this page by clicking on the link \textquotedblleft Help" in the navbar;
	\begin{figure}[H]
		\centering
...
This page contains the license. Click on the \textquotedblleft MIT License" link present in the footer of the application;
	\begin{figure}[H]
		\centering
