...
\begin{document}
	...
	La stesura dei documenti deve essere effettuata utilizzando il linguaggio di markup \citGloss{LaTeX}  e l'ambiente \citGloss{TexStudio} con dizionario italiano ed inglese installati.
	...
	\begin{itemize}
		...
		\item \textbf{Metriche per i documenti:} per la \citGloss{verifica} dei documenti è stata scelto l'indice di leggibilità Gulpease che viene calcolato tramite funzione \citGloss{LaTeX}.\\
	...
	\begin{itemize}
		...
		\item \textbf{Gestione tasklist:} \nURI{todo353swe.netlify.com} semplice sito per gestione tasklist realizzato dai membri del gruppo per utilizzo interno.
		\item \textbf{Analisi dinamica:} è stato individuato Sonarqube come possibile soluzione iniziale da accertare, per risolvere tutte le necessità di analisi del codice del gruppo. Maggiori dettagli sarannò introdotti durante la creazione dei Proof of concept per la Technology \citGloss{baseline}.
	\end{itemize}
