...
\begin{itemize}
	...
	\item \textbf{analisi:} analisi dei \citGloss{requisiti} e dei casi d'uso del gruppo vengono descritte all'interno del documento \adr \vruno;
...
\begin{itemize}
	...
	\item stabilire scelte volte alla realizzazione e realizzazione del prodotto (vincoli sui \citGloss{requisiti});
