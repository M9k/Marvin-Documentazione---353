...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\linewidth]{todo.jpg}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.1\linewidth]{todo.jpg}
...
\begin{itemize}
	\item \textbf{Attori primari:} università;
	\item \textbf{Scopo e descrizione:} l'utente è già riconosciuto dal sistema come rappresentante dell'università ed aggiunge un \citGloss{anno accademico};
...
\subsection{UC6.1.1 - Inserimento anno solare di riferimento}
	...
	\item \textbf{Postcondizione:} all'interno del sistema è stato aggiunto un nuovo l'\citGloss{anno accademico} da parte dell'utente che rappresenta l'università con l'anno solare di riferimento indicato.
\end{itemize}
...
%TODO rifare immagine, UC 7.11 illeggibile e font diverso
\begin{figure}[H]
	\centering
	\includegraphics[width=1.1\linewidth]{todo.jpg}
...
\begin{itemize}
	...
	\item \textbf{Estensioni:}
		...
		\end{enumerate}
	\item \textbf{Precondizione:} il sistema ha identificato l'utente come amministratore e ha fornito una lista di \citGloss{anni accademici} [UC7.9];
	\item \textbf{Postcondizione:} è stato creato ed inserito nel sistema un nuovo \citGloss{corso di laurea} relativo all'anno accademico indicato dall'utente.
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Precondizione:} il sistema ha ricevuto una richiesta di creazione di un \citGloss{corso di laurea} utilizzando una sigla che non rispetta i \citGloss{requisiti} indicati dal sistema; 
...
\begin{itemize}
	...
	\item \textbf{Precondizione:} il sistema ha riconosciuto l'utente come amministratore e ha fornito una lista di anni accademici [UC7.9];
...
\begin{itemize}
	...
	\end{enumerate}
	\item \textbf{Precondizione:} il sistema ha riconosciuto l'utente come amministratore e ha fornito una lista di corsi di laurea per \citGloss{anno accademico} [UC7.3];
...
\begin{itemize}
	...
	\item \textbf{Precondizione:} il sistema ha ricevuto un nome che non rispetta i \citGloss{requisiti} indicati; 
...
\begin{itemize}
	...
	\item \textbf{Scenario principale:} l'amministratore visualizza il messaggio d'errore;
	\item \textbf{Precondizione:} il sistema ha ricevuto un numero di crediti che non rispetta i \citGloss{requisiti} indicati; 
...
\subsection{UC7.6 - Visualizzazione lista esami per corso}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth]{todo.jpg}
	\caption{UC7.6 - Visualizzazione lista esami per corso}
	\label{fig:UC7.6 - Visualizzazione lista esami per corso}
\end{figure}
\subsection{UC7.6.1 - Visualizzazione sigle esami per corso di laurea}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
...
\end{itemize}
\subsection{UC7.6.2 - Visualizzazione crediti esami per corso di laurea}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
...
\end{itemize}
\subsection{UC7.6.3 - Visualizzazione nomi dei professori associati agli esami per corso di laurea se presenti}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
...
\end{itemize}
\subsection{UC7.6.4 - Visualizzazione cognomi dei professori associati agli esami per corso di laurea se presenti}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
...
\end{itemize}
\subsection{UC7.7 - Visualizzazione lista esami}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{todo.jpg}
	\caption{UC7.7 - Visualizzazione lista esami}
	\label{fig:UC7.7 - Visualizzazione lista esami}
\end{figure}
\subsection{UC7.7.1 - Visualizzazione sigla esami}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	\item \textbf{Scopo e descrizione:} l'amministratore visualizza la lista dei nomi degli esami presenti nel sistema per effettuare, eventualmente, delle operazioni su di esso;
...
\end{itemize}
\subsection{UC7.7.2 - Visualizzazione crediti esami}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	\item \textbf{Scopo e descrizione:} l'amministratore visualizza la lista dei crediti degli esami presenti nel sistema per effettuare, eventualmente, delle operazioni su di esso;
...
\end{itemize}
\subsection{UC7.7.3 - Visualizzazione sigla corsi di laurea associati ad esami se presenti}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
...
\end{itemize}
\subsection{UC7.7.4 - Visualizzazione nomi dei professori associati agli esami se presenti}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	\item \textbf{Scopo e descrizione:} l'amministratore visualizza la lista dei nomi dei professori degli esami presenti nel sistema per effettuare, eventualmente, delle operazioni su di esso;
...
\end{itemize}
\subsection{UC7.7.5 - Visualizzazione cognomi dei professori associati agli esami se presenti}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	\item \textbf{Scopo e descrizione:} l'amministratore visualizza la lista dei cognomi dei professori degli esami presenti nel sistema per effettuare, eventualmente, delle operazioni su di esso;
...
\end{itemize}
\subsection{UC7.8 - Visualizzazione dettagli esame}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	\item \textbf{Scopo e descrizione:} l'amministratore visualizza i dettagli dell'esame indicato;
	\item \textbf{Scenario principale:}
	\begin{enumerate}
		\item L'amministratore ottiene una lista degli esami e seleziona quello di suo interesse [UC7.6 o UC7.7];
		\item Il sistema mostra una schermata informativa contenente i dati relativi all'esame [UC7.8].
	\end{enumerate}
	\item \textbf{Precondizione:} il sistema ha riconosciuto l'utente come amministratore e ha precedentemente fornito un elenco di esami [UC7.6 o UC7.7]; 
...
\end{itemize}
% TODO aggiungere 7.8.7 all'immagine
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{todo.jpg}
	\caption{UC7.8 - Visualizzazione dettagli esame}
	\label{fig:UC7.8 - Visualizzazione dettagli esame}
\end{figure}
\subsection{UC7.8.1 - Visualizzazione sigla esame}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
...
\end{itemize}
\subsection{UC7.8.2 - Visualizzazione crediti esame}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
...
\end{itemize}
\subsection{UC7.8.3 - Visualizzazione corso di laurea associato all'esame se presente}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
...
\end{itemize}
\subsection{UC7.8.4 - Visualizzazione nome del professore associato all'esame se presente}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
...
\end{itemize}
\subsection{UC7.8.5 - Visualizzazione cognome del professore associato all'esame se presente}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
...
\end{itemize}
\subsection{UC7.8.6 - Visualizzazione numero di studenti iscritti all'esame}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
...
\end{itemize}
\subsection{UC7.8.7 - Visualizzazione indirizzo del professore associato all'esame se presente}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
...
\end{itemize}
\subsection{UC7.9 - Visualizzazione di tutti gli anni accademici}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
...
\begin{figure}[H]
	...
	\caption{UC7.9 - Visualizzazione di tutti gli anni accademici}
	\label{UC7.9 - Visualizzazione di tutti gli anni accademici}
\end{figure}
\subsection{UC7.9.1 - Visualizzazione anni solari relativi agli anni accademici}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
...
\end{itemize}
\subsection{UC7.10 - Visualizzazione lista professori da associare ad un esame}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	...
	\item \textbf{Precondizione:} il sistema ha riconosciuto l'utente come amministratore e ha fornito la lista degli esami [UC7.7];  
...
\begin{figure}[H]
	...
	\caption{UC7.10 - Visualizzazione lista professori da associare ad un esame}
	\label{UC7.10 - Visualizzazione lista professori da associare ad un esame}
\end{figure}
\subsection{UC7.10.1 - Visualizzazione nome per ogni professore}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
...
\end{itemize}
\subsection{UC7.10.2 - Visualizzazione cognome per ogni professore}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
...
\end{itemize}
\subsection{UC7.10.3 - Visualizzazione indirizzo per ogni professore}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
...
\end{itemize}
\subsection{UC7.11 - Associazione professore all'esame}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	...
	\item \textbf{Precondizione:} il sistema ha già fornito una lista di esami all'amministratore [UC7.10], il quale ha indicato un determinato esame e successivamente ha fornito una seconda lista contenete i professori [UC7.10]; 
...
\begin{itemize}
	...
	\item \textbf{Postcondizione:} il sistema ha fornito per ogni studente il relativo \citGloss{indirizzo}.
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Postcondizione:} il sistema ha ricevuto la \citGloss{chiave pubblica} del nuovo amministratore attraverso il campo precedentemente fornito all'utente.
\end{itemize}
