...
Si è scelto di utilizzare il software \citGloss{Trender}\footnote{\nURI{https://github.com/campagna91/Trender}} per il tracciamento automatizzato di tutte le informazioni ricavate dall'analisi dei \citGloss{requisiti}.\\
...
\begin{enumerate}
	\item \textbf{Nome interfaccia:} deve essere univoco, scritto seguendo la notazione \citGloss{CamelCase}, in inglese e in corsivo;
...
L'attività di integrazione sarà effettuata utilizzando il servizio, compatibile con \citGloss{GitHub}, \textit{\citGloss{Travis}}\footnote{\nURI{http://travis-ci.com/}}.\\
...
Per quanto riguarda il test coverage, cioè il grado di esecuzione del codice sorgente durante l'esecuzione dei test, verrà utilizzato il tool \citGloss{JavaScript} \textit{IstanbulJS}\footnote{\nURI{https://istanbul.js.org}}, mentre per la parte scritta in Solidity verrà utilizzato Solidity-Coverage\footnote{\nURI{https://github.com/sc-forks/solidity-coverage}}.\\
Le percentuali di coverage potranno essere consultate online su Metabase \footnote{\nURI{https://www.metabase.com/}}.
