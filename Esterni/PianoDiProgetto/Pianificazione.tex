...
\begin{itemize}
	...
	\item \textbf{Preventivo:}
		...
		\end{itemize}
\end{itemize}
Il primo macro periodo è a carico del gruppo \gruppo, mentre il secondo è a carico del \citGloss{committente}.\\\\ %TODO: è corretto dire che la progettazione è a carico del committente? (Mirco)
Ognuna di questi cinque fasi è poi stata scomposta nelle attività che verranno svolte durante la fase stessa, come riportato nei corrispettivi diagrammi di \citGloss{Gantt}. \`{E} stata segnata, come scadenza di ogni fase, il giorno di consegna dei materiali che sono stati prodotti dalle attività svolte. Tali scadenze sono segnate come \citGloss{milestone}.
...
Il periodo di consolidamento dei \citGloss{requisiti} inizia il 16-01-2017 e termina il 26-01-2017: comincia il giorno della consegna dei documenti per la prima scadenza e termina il giorno della presentazione della Revisione dei \citGloss{requisiti}. In questo periodo l'attività principale è il miglioramento dei documenti e dell'\adr\ in vista dell'inizio del periodo di Progettazione della base tecnologica.
...
Il periodo di Progettazione della base tecnologica inizia il \nData{26}{01}{2017} e termina il \nData{27}{02}{2017}: comincia il giorno dopo la presentazione per la Revisione dei \citGloss{requisiti} e si conclude con la consegna dei documenti per la Revisione di Progettazione. In questo periodo, le attività principali sono:
\begin{itemize}
...
Il periodo di \citGloss{validazione} e collaudo inizia con il 23-04-2018 e termina il 07-05-2018: comincia il giorno stesso della Revisione di Qualifica e si conclude con la consegna dei documenti per la Revisione di Accettazione. Durante questo periodo le attività principali svolte sono:
\begin{itemize}
