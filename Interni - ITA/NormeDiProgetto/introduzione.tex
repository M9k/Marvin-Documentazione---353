...
Lo scopo del prodotto è quello di realizzare una piattaforma web chiamata \progetto{} che simuli le funzionalità di base per studenti, docenti e università di Uniweb.\\
L'applicativo dovrà utilizzare al posto del database la rete Ethereum interagendo con degli smart contracts.
