...
\begin{document}
	\begin{letter}{Alla cortese attenzione del Committente:\\
			\smallskip
			...
			prodotto, di pianificazione e relativi criteri a garanzia della qualita: 
			\begin{itemize}
				\item Analisi dei Requisiti v 1.0.0.
				\item Glossario v 1.0.0.
				\item Piano di Progetto v 1.0.0.
				\item Piano di Qualifica v 1.0.0.
				\item Verbale Esterno ********%TODO.
				\item Norme di Progetto v 1.0.0.
				\item Studio di Fattibilita v 1.0.0.
				\end{itemize}
			gruppo 353 ha stimato di consegnare il prodotto richiesto entro il giorno ********,
		...
		\begin{flushleft}
		Cordiali saluti,\\
		\includegraphics[width=3cm]{../common/images/signature}\\
		Nome Cognome\\ %TODO
