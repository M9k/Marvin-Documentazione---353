...
\begin{longtable}[H]{|p{2.5cm}|p{2.5cm}|p{5cm}|p{2cm}|}
	...
	R0F2.2(1) & Obbligatorio & L'amministratore può confermare la registrazione di un professore & Interno \\ \hline
	%TODO: Capire quale dei due tramite red babel
	R0F2.2(2) & Obbligatorio & L'amministratore può registrare un professore & Capitolato \\ \hline
	...
	R0F3 & Obbligatorio & L'amministratore può gestire gli anni accademici & Capitolato \\ \hline %TODO: chiedese se è quello che vogliono
