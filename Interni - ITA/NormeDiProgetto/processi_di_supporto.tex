...
\begin{document}
	...
	Per le parti versionabili del progetto e per i documenti ufficiali si è scelto l'utilizzo della tecnologia Git, usando il servizio di hosting di \citGloss{repository} di GitHub.
	...
	\begin{itemize}
		...
		\item \textbf{Gestione processi e feedback:} è stato scelto di utilizzare il sistema integrato di issues presente su Github per permettere un dialogo maggiore per ogni singola issue. 
	\end{itemize}
