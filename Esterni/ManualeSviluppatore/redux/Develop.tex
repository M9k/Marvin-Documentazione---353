...
\begin{document}
	...
	As you can imagine inside the \sni{ducks} folder are placed the ducks module's files and inside the \sni{sagas} folder are placed the sagas' files. On the root level of the \sni{src} folder there are \sni{sagas.js} and \sni{reducers.js} files that deal with the aggregation of the single modules. \\
