...
\begin{longtable}[H]{p{2.6cm}p{2.5cm}p{5cm}p{2cm}}
	...
	R0F3.4.7 & Obbligatorio & L'amministratore può ottenere l'indirizzo del professore associato a un determinato corso & Interno \\
...
& & \makecell[tl]{ %TODO aggiustare alla fine
	...
	UC7.5.1 & Inserimento nome esame & R0F3.3.1\\
	UC7.5.2 & Inserimento numero crediti esami & R0F3.3.2\\
	UC7.5.3 & Inserimento obbligatorietà esame & R0F3.3.3\\
	UC7.5.4 & Visualizzazione errore nome esame non valido & R0F3.3.1\\
	UC7.5.5 & Visualizzazione errore numero crediti esame non valido & R0F3.3.2\\
	UC7.6 & Visualizzazione lista esami per \citGloss{corso di laurea} & R0F3.4 \\
	UC7.6.1 & Visualizzazione sigla esami per \citGloss{corso di laurea} & R0F3.4.1 \\
	UC7.6.2 & Visualizzazione crediti esami per \citGloss{corso di laurea} & R0F3.4.2 \\
	UC7.6.3 & Visualizzazione nomi dei professori associati agli esami per \citGloss{corso di laurea} se presenti & R0F3.4.3 \\
	UC7.6.4 & Visualizzazione cognomi dei professori associati agli esami per \citGloss{corso di laurea} se presenti & R0F3.4.3 \\
	UC7.7 & Visualizzazione lista esami & R0F3.4 \\
	UC7.7.1 & Visualizzazione sigla esami & R0F3.4.1 \\
	UC7.7.2 & Visualizzazione crediti esami & R0F3.4.2 \\
	UC7.7.3 & Visualizzazione sigle \citGloss{corsi di laurea} associati ad esami se presenti & R0F3.4.5 \\
	UC7.7.4 & Visualizzazione nomi dei professori associati agli esami se presenti & R0F3.4.3 \\
	UC7.7.5 & Visualizzazione cognomi dei professori associati agli esami se presenti & R0F3.4.3 \\
	UC7.8 & Visualizzazione dettagli esame & R0F3.4 \\
	UC7.8.1 & Visualizzazione sigla esame & R0F3.4.1 \\
	UC7.8.2 & Visualizzazione crediti esame & R0F3.4.2 \\
	UC7.8.3 & Visualizzazione corso di laurea associato all'esame se presente & R0F3.4.5 \\
	UC7.8.4 & Visualizzazione nome del professore associato all'esame se presente & R0F3.4.3 \\
	UC7.8.5 & Visualizzazione cognome del professore associato all'esame se presente & R0F3.4.3 \\
	UC7.8.6 & Visualizzazione numero di studenti iscritti all'esame & R0F3.4.6 \\
	UC7.8.7 & Visualizzazione indirizzo del professore associato all'esame se presente & R0F3.4.7 \\
	UC7.9 & Visualizzazione di tutti gli anni accademici & R0F12.3 \\
	UC7.9.1 & Visualizzazione anni solari relativi agli anni accademici & R0F12.3 \\
	UC7.10 & Visualizzazione lista professori da associare ad un esame &  \\
	UC7.10.1 & Visualizzazione nome per ogni professore & R0F3.4.3 \\
	UC7.10.2 & Visualizzazione cognome per ogni professore & R0F3.4.3 \\
	UC7.10.3 & Visualizzazione indirizzo per ogni professore & R0F3.4.4.1 \\
	UC7.11 & Associazione professore all'esame & R0F3.4.4 \\
...
\begin{longtable}[H]{p{2cm}p{5.2cm}p{5cm}}
	...
	R0F3.3.3 & I nuovi esami devono aver indicato la obbligatorietà & \makecell[tl]{
		Interno \\ 
		UC7.5.3
	} \\
