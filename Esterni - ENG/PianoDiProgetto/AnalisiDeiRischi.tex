...
\begin{longtabu} to \linewidth { >{\centering}m{.15\linewidth} >{\raggedright}m{.33\linewidth} >{\raggedright}m{0.25\linewidth} >{\centering}m{0.17\linewidth} }
	...
	&
	 \multicolumn{3}{m{0.8075\linewidth}}{Prova prova prova prova prova prova prova prova prova prova prova prova prova.} \\ %TODO rimuovo provaaaaa
	\hhline{====}
	...
	\multicolumn{3}{m{0.8075\linewidth}}{\small Si effettueranno backup bi-settimanali dei 
		dati Asana e Github, basandosi sull'affidabilità degli strumenti scelti.}\\
	\hhline{====}
