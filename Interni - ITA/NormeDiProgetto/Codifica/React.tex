...
\begin{document}	
	\subsubsection{React}
	React deve seguire tutte le norme viste sopra per il linguaggio di programmazione Javascript. In seguito sono elencate delle norme aggiuntive di JSX tratte da \textbf{Airbnb React/JSX Style Guide}\footnote{\href{https://github.com/airbnb/javascript/tree/master/react}{https://github.com/airbnb/javascript/tree/master/react}}, da utilizzare solo quando si codifica con React/JSX. 
...
omettere il valore di una proprietà quando il valore è implicitamente vero (\texttt{true}).  
