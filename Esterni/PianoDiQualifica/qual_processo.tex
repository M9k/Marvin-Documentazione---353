...
\end{center}
Dove: \begin{itemize}
	%TODO Non è tanto chiare la parte di BCWP, soprattuttto "deliverable?"
...
Per poter definire delle \citGloss{baseline} per lo sviluppo del software, è necessario che il codice venga sempre verificato.
 \begin{itemize}
 	%TODO Il termine bug non mi convince tanto. A Tullio non andava tanto a genio, non sarebbe meglio utilizzare termini come failure,  errors o fault? Comunque lasciando anche bug, non andrebbe messo nel glossario?
 ...
 \end{itemize}
\subsubsection{Strategie}
%TODO Sonarlink e Sonarqube da mettere in glossario.
...
\begin{itemize}%TODO Alcuni termini da inserire nel glossario(Esempio branch).
