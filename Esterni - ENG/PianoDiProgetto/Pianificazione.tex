...
\section{Analisi}%TODO dei requisiti? se si da mettere pure su Preventivo
...
\begin{itemize}
	...
	\item \textbf{Analisi dei Requisiti}: %TODO manca AdR
...
\begin{itemize}
	...
	\item \textbf{Bozza Twelve Factor document}: %TODO manca riferimento qui al documento richiesto da Red Babel che richiede ore per documentazione extra siccome nelle fasi precedenti non avremo un prodotto/app su cui riflettere e discutere dei 12 fattori che deve pure essere messo in verifica e collaudo come versione incrementata o semi-finale
\end{itemize}
\begin{landscape}
