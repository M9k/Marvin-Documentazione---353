...
\begin{itemize}
	...
	\item \textbf{Preventivo:}
		...
		\end{itemize}
\end{itemize}
Il primo macro periodo è a carico del gruppo \gruppo, mentre il secondo è a carico del committente.\\\\ %TODO: è corretto dire che la progettazione è a carico del committente? (Mirco)
...
Il periodo di Progettazione della base tecnologica inizia il \nData{26}{01}{2017} e termina il \nData{27}{02}{2017}: comincia il giorno dopo la presentazione per la Revisione dei Requisiti e si conclude con la consegna dei documenti per la Revisione di Progettazione. In questo periodo, le attività principali sono:
\begin{itemize}
