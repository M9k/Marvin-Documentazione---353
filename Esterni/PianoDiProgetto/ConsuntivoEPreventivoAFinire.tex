...
Durante il periodo di Analisi dei \citGloss{requisiti} è stato necessario usare più ore rispetto a quelle preventivate per il ruolo di \amme perché le attività comprendenti la stesura del \pdq, il \pdp e delle \ndp hanno necessitato più tempo rispetto a quello preventivato.
Le attività di analisi e \citGloss{verifica} hanno invece richiesto meno tempo di quello preventivato.\\
...
\begin{table}[H]
	\begin{center}	
		\begin{tabu}to \textwidth  {
			...
			Analisi dei \citGloss{requisiti} & 3.720,00 & 3.725,00\\
			Consolidamento dei \citGloss{requisiti} & 985,00 & - \\
			Progettazione della base tecnologica & 3.882,00 & - \\
			Progettazione di dettaglio e codifica & 6.713,00 & - \\
			\citGloss{validazione} e collaudo & 2.581,00 & - \\
