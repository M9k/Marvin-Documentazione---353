...
L'obbiettivo dell'analisi dei requisiti è quello di individuare ed elencare tutti i requisiti del capitolato proposto. I requisti possono essere estrapolati da più fonti:
\begin{itemize}
...
\begin{itemize}
	...
	\item \textbf{Inclusioni (se presenti):} usate per non descrivere pi`u volte lo stesso flusso di eventi,
