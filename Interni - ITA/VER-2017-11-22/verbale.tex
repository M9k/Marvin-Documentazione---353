...
\begin{itemize}
	\item \textbf{Motivo della riunione:} La riunione del \nData{22}{11}{2017} è stata svolta utilizzando il canale di comunicazione \citGloss{Slack}, e si è discusso principalmente su chiarimenti in merito all'implementazione del progetto e allo stile da seguire per la scrittura del codice. La Proponente ha esposto alcune precisazioni sui requisiti e indicato le parti sulle quali concentrare maggior impegno.
