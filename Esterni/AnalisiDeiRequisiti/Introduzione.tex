...
Lo scopo del prodotto è la creazione di una \citGloss{DAPP} accessibile da interfaccia web ed utilizzabile assieme al plugin MetaMask che consenta una gestione di un sistema che simuli le funzionalità base di UniPD.\\
Il \citGloss{front-end} del sistema consisterà in una applicazione web realizzata con \citGloss{React} e \citGloss{Redux}, mentre il back-end sarà composto da un insieme di smart contract scritti in linguaggio \citGloss{Solidity} che andranno a girare su una rete \citGloss{Ethereum}.\\
