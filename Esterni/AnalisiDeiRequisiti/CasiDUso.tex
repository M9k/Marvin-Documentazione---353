...
\begin{itemize}
	...
	\item \textbf{Scenario principale:} l'amministratore visualizza il messaggio d'errore;
	\item \textbf{Precondizione:} il sistema ha ricevuto come richiesta la creazione di un esame utilizzando campi che non rispettano i \citGloss{requisiti} indicati; 
