...
\begin{document}	
	...
	La scrittura di codice in \citGloss{JavaScript} Syntax eXtension, comunemente abbreviato in JSX, deve seguire tutte le norme descritte precedentemente per il linguaggio di programmazione \citGloss{JavaScript}.\\
...
/>
	...
	\end{center}	
	\paragraph*{Tag 1: }
i tag che non hanno figli o altro contenuto devono essere chiusi senza utilizzare il relativo tag di chiusura.  
...
\end{center}	
	\paragraph*{Tag 2: }
è vietato chiudere un tag sulla stessa riga, nel caso abbia più di una proprietà. 
