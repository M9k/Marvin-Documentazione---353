...
\begin{longtable}[H]{p{2.5cm}p{2.5cm}p{5cm}p{2cm}}
	...
	R0V3.1 & Obbligatorio & I test riguardanti gli \citGloss{smart contract} dovranno essere eseguiti in una rete locale ed almeno in una rete pubblica & Capitolato \\
...
& & \makecell[tl]{ %TODO aggiustare alla fine
	...
	UC7.6.3 & Visualizzazione sigle \citGloss{corsi di laurea} associati ad esami se presenti & R0F3.4.5 \\
	...
	UC7.9 & Visualizzazione lista professori da associare ad un esame &  \\
...
\begin{longtable}[H]{p{2cm}p{5.2cm}p{5cm}}
	...
	R0V3.1 & I test riguardanti gli \citGloss{smart contract} dovranno essere eseguiti in una rete locale ed almeno in una rete pubblica & \makecell[tl]{
		Capitolato
	} \\
