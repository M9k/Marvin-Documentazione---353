...
\newglossaryentry{build}{
	name={build},
	description={Indica la "costruzione" del prodotto software: è l'insieme di operazioni che trasformano il codice sorgente in una lista di operazioni eseguibili dal computer.}
}
%FINE BUILD
...
\newglossaryentry{release}{
	name={release},
	description={Indica la combinazione dell'output fornito dal processo di build con i file di configurazione che personalizzano l'esecuzione del programma. Una build per essere eseguita necessita di informazioni relative all'ambiente d'esecuzine della stessa, la release si occupa di fornire alla build le informazini contenute nei file di configurazione.}
}
%FINE RELEASE
...
\newglossaryentry{continuous deployment}{
	...
	description={Variante del continuous delivery, ma viene automatizzato anche il rilascio nell'ambiente di produzione}
}
