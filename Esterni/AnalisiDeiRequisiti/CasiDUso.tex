...
\end{figure}
\subsection{UC5.2.1 - Visualizzazione indirizzi degli studenti approvati}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	\item \textbf{Scopo e descrizione:} l'amministratore visualizza una lista di tutti gli indirizzi degli studenti registrati nel sistema;
	\item \textbf{Scenario principale:} l'amministratore richiede al sistema una lista di studenti per poterne visualizzare l'indirizzo ed eventualmente compiere altre operazioni su di essi;
	...
	\item \textbf{Postcondizione:} il sistema offre all'amministratore la lista degli studenti approvati con indicati i relativi indirizzi.
\end{itemize}
\subsection{UC5.2.2 - Visualizzazione nomi degli studenti approvati}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	...
	\item \textbf{Precondizione:} il sistema riconosce l'utente nel ruolo di amministratore e riceve la richiesta di visualizzazione della lista degli studenti approvati;
	\item \textbf{Postcondizione:} il sistema offre all'amministratore la lista degli studenti approvati con indicati i relativi nomi.
\end{itemize}
\subsection{UC5.2.3 - Visualizzazione cognomi degli studenti approvati}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	...
	\item \textbf{Precondizione:} il sistema riconosce l'utente nel ruolo di amministratore e riceve la richiesta di visualizzazione della lista degli studenti approvati;
	\item \textbf{Postcondizione:} il sistema offre all'amministratore la lista degli studenti approvati con indicati i relativi cognomi.
\end{itemize}
\subsection{UC5.2.4 - Visualizzazione corsi degli studenti approvati}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
