...
\begin{itemize}
	...
	\item \textbf{Postcondizione:} il sistema fornisce la guida e l'utente ha avuto delle nozioni riguardanti l'accesso al sistema.
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Postcondizione:} il sistema offre all'amministratore la lista degli utenti in attesa di approvazione con indicati i corsi universitari ai quali desiderano partecipare nel caso si tratti di studenti, altrimenti viene restituito un campo vuoto.
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Precondizione:} il sistema riconosce l'utente come amministratore e ha ricevuto una richiesta di visualizzazione dei corsi di laurea; 
...
\begin{itemize}
	...
	\item \textbf{Scenario principale:} l'amministratore richiede una lista di corsi di laurea presenti nel sistema;
	\item \textbf{Precondizione:} il sistema riconosce l'utente come amministratore e ha ricevuto una richiesta di visualizzazione dei corsi di laurea; 
	\item \textbf{Postcondizione:} il sistema fornisce all'utente l'anno accademico relativo a ogni corso di laurea.
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Precondizione:} il sistema riconosce l'utente come amministratore e ha ricevuto una richiesta di visualizzazione dei corsi di laurea relativi a un determinato anno accademico; 
...
\begin{itemize}
	...
	\item \textbf{Precondizione:} il sistema riconosce l'utente come amministratore e ha ricevuto una richiesta di visualizzazione degli esami appartenenti a un determinato corso di laurea; 
...
\begin{itemize}
	...
	\item \textbf{Precondizione:} il sistema riconosce l'utente come amministratore e ha ricevuto una richiesta di visualizzazione di tutti gli esami; 
...
\begin{itemize}
	...
	\item \textbf{Precondizione:} il sistema riconosce l'utente come amministratore e quest'ultimo ha richiesto la visualizzazione dei dettagli relativi a un esame; 
...
\begin{itemize}
	...
	\item \textbf{Precondizione:} il sistema riconosce l'utente come amministratore, il quale ha richiesto la lista di tutti gli anni accademici presenti nel sistema.
...
\begin{itemize}
	...
	\item \textbf{Precondizione:} il sistema riconosce l'utente come amministratore e ha ricevuto una richiesta di visualizzazione dei professori per poterne assegnare uno a un dato esame precedentemente indicato; 
...
\begin{itemize}
	...
	\item \textbf{Precondizione:} il sistema riconosce l'utente nel ruolo del professore, il quale ha richiesto la visualizzazione degli esami di sua competenza.
...
\begin{itemize}
	...
	\item \textbf{Precondizione:} il sistema riconosce l'utente nel ruolo del professore, il quale ha richiesto la visualizzazione degli esami di sua competenza.
	\item \textbf{Postcondizione:} il sistema fornisce per ogni esame di competenza del professore il corso di laurea al quale appartiene.
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Precondizione:} il sistema riconosce l'utente nel ruolo del professore, il quale ha richiesto la visualizzazione degli studenti registrati a un dato esame.
...
\begin{itemize}
	...
	\item \textbf{Precondizione:} il sistema riconosce l'utente nel ruolo di studente, il quale ha richiesto la lista degli esami ai quali risulta iscritto. 
...
\begin{itemize}
	...
	\item \textbf{Precondizione:} il sistema riconosce l'utente nel ruolo di studente, il quale ha richiesto la lista degli esami ai quali risulta iscritto. 
	\item \textbf{Postcondizione:} il sistema fornisce, per ogni esame al quale lo studente risulta iscritto, la relativa l'obbligatorietà.
\end{itemize}
...
\begin{itemize}
	...
	\end{enumerate}
	\item \textbf{Postcondizione:} il sistema fornisce allo studente la lista degli esami opzionali ai quali può iscriversi e quest'ultimo ne ha individuato uno di suo interesse.
...
\begin{itemize}
	...
	\item \textbf{Precondizione:} il sistema riconosce l'utente nel ruolo di rappresentante dell'università, il quale ha richiesto la visualizzazione della lista degli amministratori;
