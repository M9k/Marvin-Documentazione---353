\documentclass[Verbale171122.tex]{subfiles}
...
\begin{itemize}
	\item \textbf{Mezzo di comunicazione:} \citGloss{Slack}
...
\subsection{Argomenti}
	...
	Il proponente ha esposto alcune precisazioni sui \citGloss{requisiti} e indicato le parti sulle quali impiegare maggior impegno.
...
\begin{enumerate}
	...
	Alessandro Maccagnan: UML e' uno strumento che viene usato con profitto in un insieme specifico di casi e industrie. Per quanto riguarda la \citGloss{DOM}anda specifica vi rimando a Vardanega o Cardin. Per quanto riguarda me e Milo non abbiamo interesse ad indagare la parte di UML.\\
