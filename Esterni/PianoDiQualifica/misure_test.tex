...
\subsection{Tracciamento}%TODO Elenco non soddifa le norme specificate nel documento norme di progetto, mancano i :(2 punti). Non ero sicuro se andavano messi per come era formulato la frase. Controllare e inserire i :
...
\end{itemize}
\subsection{Efficienza}%TODO Ok, tutti gli elenchi da adesso in poi non soddisfano le norme di progetto!! Manca in tutti i : (2 punti). Controllare ed inserirli.
