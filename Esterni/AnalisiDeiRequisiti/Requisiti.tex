...
\begin{longtable}[H]{p{2.5cm}p{2.5cm}p{5cm}p{2cm}}
	...
	R0V1.1 & Obbligatorio & L'applicativo necessiterà della piattaforma Node.js per soddisfare le dipendenze delle librerie richieste citate nei requisiti sottostanti. & Capitolato \\  
