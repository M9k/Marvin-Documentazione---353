...
& & \makecell[tl]{ %TODO aggiustare alla fine
	...
	UC5.1.1.1 & Visualizzazione indirizzo dell'utente approvato & R0F1.4.1, R0F2.1.1 \\
	UC5.1.1.2 & Visualizzazione nome dell'utente approvato & R0F1.4.2, R0F2.1.2 \\
	UC5.1.1.3 & Visualizzazione cognome dell'utente approvato & R0F1.4.3, R0F2.1.3 \\
	UC5.2 & Visualizzazione lista degli studenti approvati & R0F1.4 \\
	UC5.2.1 & Visualizzazione singolo studente approvato & R0F1.4 \\
	UC5.2.1.1 & Visualizzazione nome del corsi di uno studenti approvati & R0F1.4.4 \\
	...
	UC8.1.1 & Visualizzazione esame & R0F4.1 \\
	UC8.1.1.1 & Visualizzazione sigla esame & R0F4.1.1 \\
	UC8.1.1.2 & Visualizzazione sigla del corso di laurea associato & R0F4.1.2 \\
	...
	UC9.1.1 & Visualizzazione esame & R0F5.1 \\
	UC9.1.1.1 & Visualizzazione sigla dell'esame & R0F5.1 \\
	UC9.1.1.2 & Visualizzazione numero di crediti dell'esame & R0F5.1.1 \\
	UC9.1.1.3 & Visualizzazione obbligatorietà dell'esame & R0F5.1.2 \\
	UC9.1.1.4 & Visualizzazione della valutazione dell'esame & R0F5.1.3 \\
	UC9.2 & Visualizzazione degli esami opzionali e dei loro crediti & R0F5.2 \\
	UC9.2.1 & Visualizzazione esame sottoscrivibile & R0F5.2 \\
	UC9.2.1.1 & Visualizzazione sigla dell'esame sottoscrivibile & R0F5.1.1 \\
	UC9.2.1.2 & Visualizzazione numero di crediti dell'esame sottoscrivibile & R0F5.1.1 \\
