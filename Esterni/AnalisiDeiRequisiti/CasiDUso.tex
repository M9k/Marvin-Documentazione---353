...
\begin{itemize}
	...
	\item \textbf{Postcondizione:} l'amministratore ottiene la lista desiderata.
\end{itemize}
\subsection{UC7.7.1 - Visualizzazione nomi esami per corso di laurea}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
...
\begin{itemize}
	...
	\item \textbf{Postcondizione:} l'amministratore ottiene la lista desiderata.
\end{itemize}
\subsection{UC7.8.1 - Visualizzazione nomi esami}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
	\item \textbf{Scopo e descrizione:} l'amministratore visualizza la lista dei nomi degli esami presenti nel sistema per visualizzarli ed eventualmente effettuare operazioni su di essi;
...
\end{itemize}
\subsection{UC7.8.3 - Visualizzazione sigle corsi di laurea associati ad esami se presenti}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
...
\end{itemize}
\subsection{UC7.9.1 - Visualizzazione nome esame}
\begin{itemize}
	\item \textbf{Attori primari:} amministratore;
