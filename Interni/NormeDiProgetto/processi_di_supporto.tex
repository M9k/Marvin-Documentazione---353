...
\begin{document}
	...
	\begin{itemize}
		\item \textbf{X:} rappresenta il numero di pubblicazioni formali del documento: ogni qual volta questo venga pubblicato il valore di Y e Z verrà azzerato, quello di X incrementato di uno;
