...
\begin{itemize}
	...
	\begin{itemize}
		\item \textbf{M:} indica rischi legati ai membri del gruppo 353;
...
\end{itemize}
%Per migliorare la lettura della tabella, l'attualizzazione al periodo corrente viene riportata solo per i rischi che si sono veramente verificati, in una tabella separata in fondo al documento.
...
\begin{longtabu} to \linewidth { 
	...
	%Ultimo rischio
	\rowcolor{tableLineOne} \textbf{Modifica dei requisiti RR001}
	&
