...
\subsubsection{Scss}
In questa sotto-sezione vengono elencate le norme tratte dalla \textbf{Airbnb\\ CSS/Scss Styleguide}\footnote{\nURI{https://github.com/airbnb/css}} tramite plugin Webstorm scss-lint\footnote{\nURI{https://plugins.jetbrains.com/plugin/7530-scss-lint}} con la configurazione \footnote{\nURI{https://github.com/airbnb/css/blob/master/.scss-lint.yml}}.
