...
\begin{enumerate}
	...
	\item \textbf{Utente autenticato}\\
	 Si riferisce a un utente generico con \citGloss{indirizzo} valido ed autenticato nel sistema tramite la procedura di login.\\
...
\begin{itemize}
	...
	\item \textbf{Postcondizione:} il sistema ha avvisato l'utente della necessità di dover attendere l'abilitazione del suo account da parte di un amministratore per accedere al sistema.
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Precondizione:} il sistema riconosce l'utente nel ruolo di amministratore e ha ricevuto la richiesta di visualizzazione della lista degli utenti approvati;
...
\begin{itemize}
	...
	\item \textbf{Precondizione:} il sistema riconosce l'utente nel ruolo di amministratore e ha ricevuto la richiesta di visualizzazione della lista degli studenti approvati;
...
\begin{itemize}
	...
	\item \textbf{Precondizione:} il sistema riconosce l'utente nel ruolo di amministratore e ha ricevuto la richiesta di visualizzazione della lista degli utenti in attesa di approvazione;
...
\begin{itemize}
	...
	\item \textbf{Precondizione:} il sistema riconosce l'utente nel ruolo di gestore dell'università e ha ricevuto una richiesta di visualizzazione di tutti gli anni accademici;
...
\begin{itemize}
	...
	\item \textbf{Precondizione:} il sistema ha identificato l'utente come amministratore e ha fornito una lista di \citGloss{anni accademici} [UC7.8];
	\item \textbf{Postcondizione:} è stato creato e inserito nel sistema un nuovo \citGloss{corso di laurea} relativo all'anno accademico indicato dall'utente.
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Precondizione:} il sistema ha riconosciuto l'utente come amministratore e ha ricevuto una richiesta di visualizzazione dei corsi di laurea; 
	\item \textbf{Postcondizione:} il sistema ha fornito all'utente la sigla relativa a ogni corso di laurea.
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Scenario principale:} l'amministratore richiede una lista di corsi di laurea presenti nel sistema;
	\item \textbf{Precondizione:} il sistema ha riconosciuto l'utente come amministratore e ha ricevuto una richiesta di visualizzazione dei corsi di laurea; 
	\item \textbf{Postcondizione:} il sistema ha fornito all'utente l'anno accademico relativo a ogni corso di laurea.
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Precondizione:} il sistema ha riconosciuto l'utente come amministratore e ha ricevuto una richiesta di visualizzazione dei corsi di laurea relativi a un determinato anno accademico; 
	\item \textbf{Postcondizione:} il sistema ha fornito all'utente la sigla relativa a ogni corso di laurea dell'anno accademico indicatogli.
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Precondizione:} il sistema ha riconosciuto l'utente come amministratore e ha fornito una lista di corsi di laurea per \citGloss{anno accademico} [UC7.2];
...
\begin{itemize}
	...
	\end{enumerate}
	\item \textbf{Precondizione:} il sistema ha riconosciuto l'utente come amministratore e ha già fornito una lista dei corsi di laurea [UC7.2 o UC7.3]; 
...
\begin{itemize}
	...
	\item \textbf{Precondizione:} il sistema ha riconosciuto l'utente come amministratore e ha ricevuto una richiesta di visualizzazione degli esami appartenenti a un determinato corso di laurea; 
	\item \textbf{Postcondizione:} il sistema ha fornito all'amministratore il numero di crediti relativi a ogni esame presente nel corso di laurea indicatogli.
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Precondizione:} il sistema ha riconosciuto l'utente come amministratore e ha ricevuto una richiesta di visualizzazione di tutti gli esami; 
	\item \textbf{Postcondizione:} il sistema ha fornito all'amministratore il numero di crediti relativi a ogni esame presente.
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Precondizione:} il sistema ha riconosciuto l'utente come amministratore e quest'ultimo ha richiesto la visualizzazione dei dettagli relativi a un esame; 
...
\begin{itemize}
	...
	\item \textbf{Postcondizione:} il sistema ha fornito all'amministratore la lista dei professori per permettere l'assegnazione di uno di essi a un dato esame indicato dall'utente.
\end{itemize}
\begin{figure}[H]
	\centering
...
\begin{itemize}
	...
	\item \textbf{Precondizione:} il sistema ha riconosciuto l'utente nel ruolo del professore, il quale ha richiesto la visualizzazione degli studenti registrati a un dato esame.
...
\begin{itemize}
	...
	\end{enumerate}
	\item \textbf{Precondizione:} il sistema ha fornito al professore la lista degli esami di sua competenza [UC8.1] e, dopo che l'utente ne ha indicato uno, ha fornito la lista degli studenti registrati a esso [UC8.2];
