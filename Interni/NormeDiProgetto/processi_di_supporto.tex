...
\begin{document}
	...
	\subsubsection{Struttura dei documenti}
		Ogni documento è realizzato a partire da una disposizione prestabilita che dovrà essere conforme per ogni documento ufficiale ad eccezione dei verbali: %TODO perché ad accezzione dei verbali?
		\begin{itemize}
	...
	\begin{itemize}
		...
		\item \textbf{Metriche per il software:} al fine di perseguire gli obiettivi qualitati prefissati nel Piano Di Qualifica è doveroso definire delle metriche come copertura del codice tramite test automatici; %TODO riferimenti a sucessive revisioni?
