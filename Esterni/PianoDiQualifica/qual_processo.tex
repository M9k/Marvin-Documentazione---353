...
\subsubsection{Obiettivi:}
\begin{itemize}
	\item \textbf{Commit frequenti:} I commit effettuati dai membri gruppo devono essere frequenti affinchè il codice sia sempre aggiornato;
...
\begin{table}[H]
	\begin{center}
		\begin{tabu} to \textwidth {
			...
			\textlink{MPS009}{MPS009TAB}{MPS009} & Media numero commit per settimana & & \\
			\item \textlink{MPS010}{MPS010TAB}{MPS010} & Media numero build Travis per settimana & & \\
			\item \textlink{MPS011}{MPS011TAB}{MPS011} & Percentuale build fallite & & \\
