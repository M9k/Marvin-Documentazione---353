...
\begin{longtabu} to \linewidth { 
	...
	%Primo rischio
	\rowcolor{tableLineOne} \textbf{Scarsa esperienza RM001} (Membri 353)
	&
	...
	%Secondo rischio
	\rowcolor{tableLineOne} \textbf{Contrasti nel gruppo RM002} (Membri 353)
	&
	...
	%Terzo rischio
	\rowcolor{tableLineOne} \textbf{Disponibilità dei membri RM003} (Membri 353)
	&
	...
	%Quarto rischio
	\rowcolor{tableLineOne} \textbf{Tecnologie da usare RT001} (Tecnologico)
	&
	...
	%Quinto rischio
	\rowcolor{tableLineOne} \textbf{Strumenti software RT002}  (Tecnologico)
	&
	...
	\hhline{====}
		...
		%Sesto rischio
	\rowcolor{tableLineOne} \textbf{Problemi hardware RT003} (Tecnologico)
	&
	...
	%Settimo rischio
	\rowcolor{tableLineOne} \textbf{Costi delle attività RO001} (Organizza-
	tivo)
	 &
	...
	%Ultimo rischio
	\rowcolor{tableLineOne} \textbf{Modifica dei requisiti RR001} (Requisiti)
	&
