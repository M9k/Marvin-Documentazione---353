...
\begin{figure}[H]
	...
	\caption{Percentuale test case, range ottimale}
	\label{fig:mtsa001-2}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Ultimo valore Gulpease prima consegna RA, range ottimale}
	\label{fig:processi}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Andamento valore Gulpease documenti successivo consegna RQ, range ottimale}
	\label{fig:processi}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Ultimo valore Flesch prima consegna RA, range ottimale}
	\label{fig:processi}
\end{figure}
\newpage
...
\begin{figure}[H]
	...
	\caption{Copertura requisiti obbligatori e accettati, range ottimale}
	\label{fig:mpds001-2}
\end{figure}

\textbf{MPDS006 Comprensibilità funzioni offerte}
\newline
CFC = 100\% con i test avuti con la proponente, range ottimale
\newline

\textbf{MPDS007 Apprendimento funzionalità}
\newline
Tempo medio = 5/7 minuti, range ottimale
\newline

\textbf{MPDS009 Tempo di risposta}
\newline
Tempo risposta = 1.81s, range ottimale
\begin{figure}[H]
	\centering
	\includegraphics[width=1\linewidth]{RA/MPDS009}
